...
typedef цел ТипСобытия;
		...
		//! \cond EXTERN
		static extern (C) ТипСобытия wxEvent_GetEventType(ЦУк сам);
		static extern (C) цел    wxEvent_GetId(ЦУк сам);
		static extern (C) бул   wxEvent_GetSkipped(ЦУк сам);
		static extern (C) цел    wxEvent_GetTimestamp(ЦУк сам);
		static extern (C) проц   wxEvent_Skip(ЦУк сам, бул skip);
		static extern (C) ЦУк wxEvent_GetEventObject(ЦУк сам);
		static extern (C) проц   wxEvent_SetEventObject(ЦУк сам, ЦУк object);
...
version(__WXMSW__){
		...
		alias static Событие function(ЦУк шхобъ) newfunc;

		protected static newfunc[ТипСобытия] funcmap;
	
		//---------------------------------------------------------------------
		private static Событие Нов(ЦУк объ);
		...
		public static Событие СоздайИз(ЦУк wxEvent)
		{
		...
		public ТипСобытия ТипСоб() { return wxEvent_GetEventType(шхобъ); }

		//---------------------------------------------------------------------

		public цел ИД() { return wxEvent_GetId(шхобъ); }
		...
		{
			wxEvent_Skip(шхобъ, skip);
		}

		//---------------------------------------------------------------------

		public бул Пропущен() { return wxEvent_GetSkipped(шхобъ); }

		//---------------------------------------------------------------------

		public цел ШтампВремени() { return wxEvent_GetTimestamp(шхобъ); }

		//---------------------------------------------------------------------

		public wxObject ОбъСоб() { return FindObject(wxEvent_GetEventObject(шхобъ)); }

		public проц ОбъСоб(wxObject объ) { wxEvent_SetEventObject(шхобъ, объ.шхобъ); }

		//---------------------------------------------------------------------

		public ЦУк ЦУкСоб() { return wxEvent_GetEventObject(шхобъ); }

		public проц ЦУкСоб(ЦУк ptr) { return wxEvent_SetEventObject(шхобъ, ptr); }
