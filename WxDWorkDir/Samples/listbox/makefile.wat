...
LISTBOX_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
$(OBJS)\listbox.exe :  $(LISTBOX_OBJECTS) $(OBJS)\listbox_sample.res
	@%create $(OBJS)\listbox.lbc
	@%append $(OBJS)\listbox.lbc option quiet
	@%append $(OBJS)\listbox.lbc name $^@
	@%append $(OBJS)\listbox.lbc option caseexact
	@%append $(OBJS)\listbox.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(LDFLAGS)
	@for %i in ($(LISTBOX_OBJECTS)) do @%append $(OBJS)\listbox.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__GDIPLUS_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append $(OBJS)\listbox.lbc library %i
	@%append $(OBJS)\listbox.lbc option resource=$(OBJS)\listbox_sample.res
	@for %i in () do @%append $(OBJS)\listbox.lbc option stack=%i
...
$(OBJS)\listbox_lboxtest.obj :  .AUTODEPEND .\lboxtest.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(LISTBOX_CXXFLAGS) $<
