...
const CommonInfo g_CommonPrefs = {
    ...
    нет, // readOnlyInitial
    нет,  // wrapModeInitial
    нет, // displayEOLEnable
    нет, // IndentGuideEnable
    да,  // lineNumberEnable
    нет, // longLineOnEnable
    нет, // whiteSpaceEnable
};
...
const ткст CppWordlist1 =
    "asm auto бул break case catch сим class const const_cast "
    "continue default delete do дво dynamic_cast else enum explicit "
    "export extern нет float for friend goto if inline цел long "
...
const ткст CppWordlist3 =
    "a addindex addtogroup anchor arg attention author с brief bug c "
...
const ткст DWordlist1 =
	...
	"cast catch cdouble cent cfloat сим class const continue creal "
	"dchar debug default delegate delete deprecated do дво else "
	"enum export extern нет final finally float for foreach "
	"foreach_reverse function goto idouble if ifloat import in "
	"inout цел interface invariant ireal is lazy long macro mixin "
	"module new пусто out override package pragma private protected "
	...
	"ббайт ucent бцел ulong union unittest ushort version проц "
...
const LanguageInfo g_LanguagePrefs [] = [
    ...
    {"C++",
     ...
     [{mySTC_TYPE_DEFAULT, пусто},
      {mySTC_TYPE_COMMENT, пусто},
      {mySTC_TYPE_COMMENT_LINE, пусто},
      {mySTC_TYPE_COMMENT_DOC, пусто},
      {mySTC_TYPE_NUMBER, пусто},
      {mySTC_TYPE_WORD1, CppWordlist1}, // KEYWORDS
      {mySTC_TYPE_STRING, пусто},
      {mySTC_TYPE_CHARACTER, пусто},
      {mySTC_TYPE_UUID, пусто},
      {mySTC_TYPE_PREPROCESSOR, пусто},
      {mySTC_TYPE_OPERATOR, пусто},
      {mySTC_TYPE_IDENTIFIER, пусто},
      {mySTC_TYPE_STRING_EOL, пусто},
      {mySTC_TYPE_DEFAULT, пусто}, // VERBATIM
      {mySTC_TYPE_REGEX, пусто},
      {mySTC_TYPE_COMMENT_SPECIAL, пусто}, // DOXY
      {mySTC_TYPE_WORD2, CppWordlist2}, // EXTRA WORDS
      {mySTC_TYPE_WORD3, CppWordlist3}, // DOXY KEYWORDS
      {mySTC_TYPE_ERROR, пусто}, // KEYWORDS ERROR
      {-1, пусто},
      {-1, пусто},
      {-1, пусто},
      {-1, пусто},
    ...
    {"D",
     ...
     [{mySTC_TYPE_DEFAULT, пусто},
      ...
      {mySTC_TYPE_REGEX, пусто},
      {mySTC_TYPE_COMMENT_SPECIAL, пусто}, // DOXY
      {mySTC_TYPE_WORD2, пусто}, // EXTRA WORDS
      {mySTC_TYPE_WORD3, пусто}, // DOXY KEYWORDS
      {mySTC_TYPE_ERROR, пусто}, // KEYWORDS ERROR
      {-1, пусто},
      {-1, пусто},
      {-1, пусто},
    ...
    {"Python",
     ...
     [{mySTC_TYPE_DEFAULT, пусто},
      ...
      {mySTC_TYPE_DEFAULT, пусто}, // TRIPLE
      {mySTC_TYPE_DEFAULT, пусто}, // TRIPLEDOUBLE
      {mySTC_TYPE_DEFAULT, пусто}, // CLASSNAME
      {mySTC_TYPE_DEFAULT, PythonWordlist2}, // DEFNAME
      {mySTC_TYPE_OPERATOR, пусто},
      {mySTC_TYPE_IDENTIFIER, пусто},
      {mySTC_TYPE_DEFAULT, пусто}, // COMMENT_BLOCK
      {mySTC_TYPE_STRING_EOL, пусто},
      {-1, пусто},
      {-1, пусто},
      {-1, пусто},
