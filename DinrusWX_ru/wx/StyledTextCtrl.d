...
//! \endcond
    ...
    static extern (C) ЦелУкз wxStyledTextCtrl_ctor(ЦелУкз родитель, цел ид, inout Точка поз, inout Размер Размер, бцел стиль, ткст имя);
    static extern (C) проц   wxStyledTextCtrl_AddText(ЦелУкз сам, ткст текст);
    //static extern (C) проц   wxStyledTextCtrl_AddStyledText(ЦелУкз сам, ЦелУкз data);
    static extern (C) проц   wxStyledTextCtrl_InsertText(ЦелУкз сам, цел поз, ткст текст);
    static extern (C) проц   wxStyledTextCtrl_ClearAll(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_ClearDocumentStyle(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetLength(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetCharAt(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_GetCurrentPos(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetAnchor(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetStyleAt(ЦелУкз сам, цел поз);
    static extern (C) проц   wxStyledTextCtrl_Redo(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetUndoCollection(ЦелУкз сам, бул collectUndo);
    static extern (C) проц   wxStyledTextCtrl_SelectAll(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetSavePoint(ЦелУкз сам);
    //static extern (C) ЦелУкз wxStyledTextCtrl_GetStyledText(ЦелУкз сам, цел startPos, цел endPos);
    static extern (C) бул   wxStyledTextCtrl_CanRedo(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_MarkerLineFromHandle(ЦелУкз сам, цел handle);
    static extern (C) проц   wxStyledTextCtrl_MarkerDeleteHandle(ЦелУкз сам, цел handle);
    static extern (C) бул   wxStyledTextCtrl_GetUndoCollection(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetViewWhiteSpace(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetViewWhiteSpace(ЦелУкз сам, цел viewWS);
    static extern (C) цел    wxStyledTextCtrl_PositionFromPoint(ЦелУкз сам, inout Точка тчк);
    static extern (C) цел    wxStyledTextCtrl_PositionFromPointClose(ЦелУкз сам, цел x, цел y);
    static extern (C) проц   wxStyledTextCtrl_GotoLine(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_GotoPos(ЦелУкз сам, цел поз);
    static extern (C) проц   wxStyledTextCtrl_SetAnchor(ЦелУкз сам, цел posAnchor);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetCurLine(ЦелУкз сам, inout цел linePos);
    static extern (C) цел    wxStyledTextCtrl_GetEndStyled(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_ConvertEOLs(ЦелУкз сам, цел eolMode);
    static extern (C) цел    wxStyledTextCtrl_GetEOLMode(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetEOLMode(ЦелУкз сам, цел eolMode);
    static extern (C) проц   wxStyledTextCtrl_StartStyling(ЦелУкз сам, цел поз, цел маска);
    static extern (C) проц   wxStyledTextCtrl_SetStyling(ЦелУкз сам, цел length, цел стиль);
    static extern (C) бул   wxStyledTextCtrl_GetBufferedDraw(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetBufferedDraw(ЦелУкз сам, бул buffered);
    static extern (C) проц   wxStyledTextCtrl_SetTabWidth(ЦелУкз сам, цел tabWidth);
    static extern (C) цел    wxStyledTextCtrl_GetTabWidth(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetCodePage(ЦелУкз сам, цел codePage);
    static extern (C) проц   wxStyledTextCtrl_MarkerDefine(ЦелУкз сам, цел markerNumber, цел markerSymbol, ЦелУкз foreground, ЦелУкз background);
    static extern (C) проц   wxStyledTextCtrl_MarkerУстForeground(ЦелУкз сам, цел markerNumber, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_MarkerУстBackground(ЦелУкз сам, цел markerNumber, ЦелУкз back);
    static extern (C) цел    wxStyledTextCtrl_MarkerAdd(ЦелУкз сам, цел line, цел markerNumber);
    static extern (C) проц   wxStyledTextCtrl_MarkerDelete(ЦелУкз сам, цел line, цел markerNumber);
    static extern (C) проц   wxStyledTextCtrl_MarkerDeleteAll(ЦелУкз сам, цел markerNumber);
    static extern (C) цел    wxStyledTextCtrl_MarkerGet(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_MarkerNext(ЦелУкз сам, цел lineStart, цел markerMask);
    static extern (C) цел    wxStyledTextCtrl_MarkerPrevious(ЦелУкз сам, цел lineStart, цел markerMask);
    static extern (C) проц   wxStyledTextCtrl_MarkerDefineBitmap(ЦелУкз сам, цел markerNumber, ЦелУкз bmp);
    static extern (C) проц   wxStyledTextCtrl_SetMarginType(ЦелУкз сам, цел margin, цел marginType);
    static extern (C) цел    wxStyledTextCtrl_GetMarginType(ЦелУкз сам, цел margin);
    static extern (C) проц   wxStyledTextCtrl_SetMarginWidth(ЦелУкз сам, цел margin, цел pixelWidth);
    static extern (C) цел    wxStyledTextCtrl_GetMarginWidth(ЦелУкз сам, цел margin);
    static extern (C) проц   wxStyledTextCtrl_SetMarginMask(ЦелУкз сам, цел margin, цел маска);
    static extern (C) цел    wxStyledTextCtrl_GetMarginMask(ЦелУкз сам, цел margin);
    static extern (C) проц   wxStyledTextCtrl_SetMarginSensitive(ЦелУкз сам, цел margin, бул sensitive);
    static extern (C) бул   wxStyledTextCtrl_GetMarginSensitive(ЦелУкз сам, цел margin);
    static extern (C) проц   wxStyledTextCtrl_StyleClearAll(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_StyleУстForeground(ЦелУкз сам, цел стиль, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_StyleУстBackground(ЦелУкз сам, цел стиль, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_StyleУстBold(ЦелУкз сам, цел стиль, бул bold);
    static extern (C) проц   wxStyledTextCtrl_StyleУстItalic(ЦелУкз сам, цел стиль, бул italic);
    static extern (C) проц   wxStyledTextCtrl_StyleУстSize(ЦелУкз сам, цел стиль, цел sizePoints);
    static extern (C) проц   wxStyledTextCtrl_StyleУстFaceName(ЦелУкз сам, цел стиль, ткст fontName);
    static extern (C) проц   wxStyledTextCtrl_StyleУстEOLFilled(ЦелУкз сам, цел стиль, бул filled);
    static extern (C) проц   wxStyledTextCtrl_StyleResetDefault(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_StyleУстUnderline(ЦелУкз сам, цел стиль, бул underline);
    static extern (C) проц   wxStyledTextCtrl_StyleУстCase(ЦелУкз сам, цел стиль, цел caseForce);
    static extern (C) проц   wxStyledTextCtrl_StyleУстCharacterУст(ЦелУкз сам, цел стиль, цел characterУст);
    static extern (C) проц   wxStyledTextCtrl_StyleУстHotSpot(ЦелУкз сам, цел стиль, бул hotspot);
    static extern (C) проц   wxStyledTextCtrl_SetSelForeground(ЦелУкз сам, бул useУстting, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_SetSelBackground(ЦелУкз сам, бул useУстting, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_SetCaretForeground(ЦелУкз сам, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_CmdKeyAssign(ЦелУкз сам, цел key, цел modifiers, цел кмд);
    static extern (C) проц   wxStyledTextCtrl_CmdKeyClear(ЦелУкз сам, цел key, цел modifiers);
    static extern (C) проц   wxStyledTextCtrl_CmdKeyClearAll(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetStyleBytes(ЦелУкз сам, цел length, ubyte* styleBytes);
    static extern (C) проц   wxStyledTextCtrl_StyleУстVisible(ЦелУкз сам, цел стиль, бул visible);
    static extern (C) цел    wxStyledTextCtrl_GetCaretPeriod(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetCaretPeriod(ЦелУкз сам, цел periodMilliseconds);
    static extern (C) проц   wxStyledTextCtrl_SetWordChars(ЦелУкз сам, ткст characters);
    static extern (C) проц   wxStyledTextCtrl_BeginUndoAction(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_EndUndoAction(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_IndicatorУстStyle(ЦелУкз сам, цел indic, цел стиль);
    static extern (C) цел    wxStyledTextCtrl_IndicatorGetStyle(ЦелУкз сам, цел indic);
    static extern (C) проц   wxStyledTextCtrl_IndicatorУстForeground(ЦелУкз сам, цел indic, ЦелУкз fore);
    static extern (C) ЦелУкз wxStyledTextCtrl_IndicatorGetForeground(ЦелУкз сам, цел indic);
    static extern (C) проц   wxStyledTextCtrl_SetWhitespaceForeground(ЦелУкз сам, бул useУстting, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_SetWhitespaceBackground(ЦелУкз сам, бул useУстting, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_SetStyleBits(ЦелУкз сам, цел bits);
    static extern (C) цел    wxStyledTextCtrl_GetStyleBits(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetLineState(ЦелУкз сам, цел line, цел state);
    static extern (C) цел    wxStyledTextCtrl_GetLineState(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_GetMaxLineState(ЦелУкз сам);
    static extern (C) бул   wxStyledTextCtrl_GetCaretLineVisible(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetCaretLineVisible(ЦелУкз сам, бул покажи);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetCaretLineBack(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetCaretLineBack(ЦелУкз сам, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_StyleУстChangeable(ЦелУкз сам, цел стиль, бул changeable);
    static extern (C) проц   wxStyledTextCtrl_AutoCompShow(ЦелУкз сам, цел lenEntered, ткст элтList);
    static extern (C) проц   wxStyledTextCtrl_AutoCompCancel(ЦелУкз сам);
    static extern (C) бул   wxStyledTextCtrl_AutoCompActive(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_AutoCompPosStart(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompComplete(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompStops(ЦелУкз сам, ткст characterУст);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстSeparator(ЦелУкз сам, цел separatorCharacter);
    static extern (C) цел    wxStyledTextCtrl_AutoCompGetSeparator(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompSelect(ЦелУкз сам, ткст текст);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстCancelAtStart(ЦелУкз сам, бул cancel);
    static extern (C) бул   wxStyledTextCtrl_AutoCompGetCancelAtStart(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстFillUps(ЦелУкз сам, ткст characterУст);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстChooseSingle(ЦелУкз сам, бул chooseSingle);
    static extern (C) бул   wxStyledTextCtrl_AutoCompGetChooseSingle(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстIgnoreCase(ЦелУкз сам, бул ignoreCase);
    static extern (C) бул   wxStyledTextCtrl_AutoCompGetIgnoreCase(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_UserListShow(ЦелУкз сам, цел listType, ткст элтList);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстAutoHide(ЦелУкз сам, бул autoHide);
    static extern (C) бул   wxStyledTextCtrl_AutoCompGetAutoHide(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстDropRestOfWord(ЦелУкз сам, бул dropRestOfWord);
    static extern (C) бул   wxStyledTextCtrl_AutoCompGetDropRestOfWord(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_RegisterImage(ЦелУкз сам, цел тип, ЦелУкз bmp);
    static extern (C) проц   wxStyledTextCtrl_ClearRegisteredImages(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_AutoCompGetTypeSeparator(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AutoCompУстTypeSeparator(ЦелУкз сам, цел separatorCharacter);
    static extern (C) проц   wxStyledTextCtrl_SetIndent(ЦелУкз сам, цел indentSize);
    static extern (C) цел    wxStyledTextCtrl_GetIndent(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetUseTabs(ЦелУкз сам, бул useTabs);
    static extern (C) бул   wxStyledTextCtrl_GetUseTabs(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetLineIndentation(ЦелУкз сам, цел line, цел indentSize);
    static extern (C) цел    wxStyledTextCtrl_GetLineIndentation(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_GetLineIndentPosition(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_GetColumn(ЦелУкз сам, цел поз);
    static extern (C) проц   wxStyledTextCtrl_SetUseHorizontalScrollBar(ЦелУкз сам, бул покажи);
    static extern (C) бул   wxStyledTextCtrl_GetUseHorizontalScrollBar(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetIndentationGuides(ЦелУкз сам, бул покажи);
    static extern (C) бул   wxStyledTextCtrl_GetIndentationGuides(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetHighlightGuide(ЦелУкз сам, цел column);
    static extern (C) цел    wxStyledTextCtrl_GetHighlightGuide(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetLineEndPosition(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_GetCodePage(ЦелУкз сам);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetCaretForeground(ЦелУкз сам);
    static extern (C) бул   wxStyledTextCtrl_GetReadOnly(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetCurrentPos(ЦелУкз сам, цел поз);
    static extern (C) проц   wxStyledTextCtrl_SetSelectionStart(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_GetSelectionStart(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetSelectionEnd(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_GetSelectionEnd(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetPrintMagnification(ЦелУкз сам, цел magnification);
    static extern (C) цел    wxStyledTextCtrl_GetPrintMagnification(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetPrintColourMode(ЦелУкз сам, цел mode);
    static extern (C) цел    wxStyledTextCtrl_GetPrintColourMode(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_FindText(ЦелУкз сам, цел minPos, цел maxPos, ткст текст, цел флаги);
    static extern (C) цел    wxStyledTextCtrl_FormatRange(ЦелУкз сам, бул doDraw, цел startPos, цел endPos, ЦелУкз draw, ЦелУкз target, inout Прямоугольник renderRect, inout Прямоугольник pageRect);
    static extern (C) цел    wxStyledTextCtrl_GetFirstVisibleLine(ЦелУкз сам);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetLine(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_GetLineCount(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetMarginLeft(ЦелУкз сам, цел pixelWidth);
    static extern (C) цел    wxStyledTextCtrl_GetMarginLeft(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetMarginRight(ЦелУкз сам, цел pixelWidth);
    static extern (C) цел    wxStyledTextCtrl_GetMarginRight(ЦелУкз сам);
    static extern (C) бул   wxStyledTextCtrl_GetModify(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetSelection(ЦелУкз сам, цел start, цел end);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetSelectedText(ЦелУкз сам);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetTextRange(ЦелУкз сам, цел startPos, цел endPos);
    static extern (C) проц   wxStyledTextCtrl_HideSelection(ЦелУкз сам, бул normal);
    static extern (C) цел    wxStyledTextCtrl_LineFromPosition(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_PositionFromLine(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_LineScroll(ЦелУкз сам, цел columns, цел строки);
    static extern (C) проц   wxStyledTextCtrl_EnsureCaretVisible(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_ReplaceSelection(ЦелУкз сам, ткст текст);
    static extern (C) проц   wxStyledTextCtrl_SetReadOnly(ЦелУкз сам, бул readOnly);
    static extern (C) бул   wxStyledTextCtrl_CanPaste(ЦелУкз сам);
    static extern (C) бул   wxStyledTextCtrl_CanUndo(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_EmptyUndoBuffer(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_Undo(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_Cut(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_Copy(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_Paste(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_Clear(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetText(ЦелУкз сам, ткст текст);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetText(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_GetTextLength(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetOvertype(ЦелУкз сам, бул overtype);
    static extern (C) бул   wxStyledTextCtrl_GetOvertype(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetCaretWidth(ЦелУкз сам, цел pixelWidth);
    static extern (C) цел    wxStyledTextCtrl_GetCaretWidth(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetTargetStart(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_GetTargetStart(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetTargetEnd(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_GetTargetEnd(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_ReplaceTarget(ЦелУкз сам, ткст текст);
    static extern (C) цел    wxStyledTextCtrl_ReplaceTargetRE(ЦелУкз сам, ткст текст);
    static extern (C) цел    wxStyledTextCtrl_SearchInTarget(ЦелУкз сам, ткст текст);
    static extern (C) проц   wxStyledTextCtrl_SetSearchФлаги(ЦелУкз сам, цел флаги);
    static extern (C) цел    wxStyledTextCtrl_GetSearchФлаги(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_CallTipShow(ЦелУкз сам, цел поз, ткст definition);
    static extern (C) проц   wxStyledTextCtrl_CallTipCancel(ЦелУкз сам);
    static extern (C) бул   wxStyledTextCtrl_CallTipActive(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_CallTipPosAtStart(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_CallTipУстHighlight(ЦелУкз сам, цел start, цел end);
    static extern (C) проц   wxStyledTextCtrl_CallTipУстBackground(ЦелУкз сам, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_CallTipУстForeground(ЦелУкз сам, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_CallTipУстForegroundHighlight(ЦелУкз сам, ЦелУкз fore);
    static extern (C) цел    wxStyledTextCtrl_VisibleFromDocLine(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_DocLineFromVisible(ЦелУкз сам, цел lineDisplay);
    static extern (C) проц   wxStyledTextCtrl_SetFoldLevel(ЦелУкз сам, цел line, цел level);
    static extern (C) цел    wxStyledTextCtrl_GetFoldLevel(ЦелУкз сам, цел line);
    static extern (C) цел    wxStyledTextCtrl_GetLastChild(ЦелУкз сам, цел line, цел level);
    static extern (C) цел    wxStyledTextCtrl_GetFoldParent(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_ShowLines(ЦелУкз сам, цел lineStart, цел lineEnd);
    static extern (C) проц   wxStyledTextCtrl_HideLines(ЦелУкз сам, цел lineStart, цел lineEnd);
    static extern (C) бул   wxStyledTextCtrl_GetLineVisible(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_SetFoldExpanded(ЦелУкз сам, цел line, бул expanded);
    static extern (C) бул   wxStyledTextCtrl_GetFoldExpanded(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_ToggleFold(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_EnsureVisible(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_SetFoldФлаги(ЦелУкз сам, цел флаги);
    static extern (C) проц   wxStyledTextCtrl_EnsureVisibleEnforcePolicy(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_SetTabIndents(ЦелУкз сам, бул tabIndents);
    static extern (C) бул   wxStyledTextCtrl_GetTabIndents(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetBackSpaceUnIndents(ЦелУкз сам, бул bsUnIndents);
    static extern (C) бул   wxStyledTextCtrl_GetBackSpaceUnIndents(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetMouseDwellTime(ЦелУкз сам, цел periodMilliseconds);
    static extern (C) цел    wxStyledTextCtrl_GetMouseDwellTime(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_WordStartPosition(ЦелУкз сам, цел поз, бул onlyWordCharacters);
    static extern (C) цел    wxStyledTextCtrl_WordEndPosition(ЦелУкз сам, цел поз, бул onlyWordCharacters);
    static extern (C) проц   wxStyledTextCtrl_SetWrapMode(ЦелУкз сам, цел mode);
    static extern (C) цел    wxStyledTextCtrl_GetWrapMode(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetLayoutCache(ЦелУкз сам, цел mode);
    static extern (C) цел    wxStyledTextCtrl_GetLayoutCache(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetScrollWidth(ЦелУкз сам, цел pixelWidth);
    static extern (C) цел    wxStyledTextCtrl_GetScrollWidth(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_TextWidth(ЦелУкз сам, цел стиль, ткст текст);
    static extern (C) проц   wxStyledTextCtrl_SetEndAtLastLine(ЦелУкз сам, бул endAtLastLine);
    static extern (C) бул   wxStyledTextCtrl_GetEndAtLastLine(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_TextHeight(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_SetUseVerticalScrollBar(ЦелУкз сам, бул покажи);
    static extern (C) бул   wxStyledTextCtrl_GetUseVerticalScrollBar(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AppendText(ЦелУкз сам, цел length, ткст текст);
    static extern (C) бул   wxStyledTextCtrl_GetTwoPhaseDraw(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetTwoPhaseDraw(ЦелУкз сам, бул twoPhase);
    static extern (C) проц   wxStyledTextCtrl_TargetFromSelection(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_LinesJoin(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_LinesSplit(ЦелУкз сам, цел pixelWidth);
    static extern (C) проц   wxStyledTextCtrl_SetFoldMarginColour(ЦелУкз сам, бул useУстting, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_SetFoldMarginHiColour(ЦелУкз сам, бул useУстting, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_LineDuplicate(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_HomeDisplay(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_HomeDisplayExtend(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_LineEndDisplay(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_LineEndDisplayExtend(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_MoveCaretInsideView(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_LineLength(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_BraceHighlight(ЦелУкз сам, цел pos1, цел pos2);
    static extern (C) проц   wxStyledTextCtrl_BraceBadLight(ЦелУкз сам, цел поз);
    static extern (C) цел    wxStyledTextCtrl_BraceMatch(ЦелУкз сам, цел поз);
    static extern (C) бул   wxStyledTextCtrl_GetViewEOL(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetViewEOL(ЦелУкз сам, бул visible);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetDocPointer(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetDocPointer(ЦелУкз сам, ЦелУкз docPointer);
    static extern (C) проц   wxStyledTextCtrl_SetModEventMask(ЦелУкз сам, цел маска);
    static extern (C) цел    wxStyledTextCtrl_GetEdgeColumn(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetEdgeColumn(ЦелУкз сам, цел column);
    static extern (C) цел    wxStyledTextCtrl_GetEdgeMode(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetEdgeMode(ЦелУкз сам, цел mode);
    static extern (C) ЦелУкз wxStyledTextCtrl_GetEdgeColour(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetEdgeColour(ЦелУкз сам, ЦелУкз edgeColour);
    static extern (C) проц   wxStyledTextCtrl_SearchAnchor(ЦелУкз сам);
    static extern (C) цел    wxStyledTextCtrl_SearchNext(ЦелУкз сам, цел флаги, ткст текст);
    static extern (C) цел    wxStyledTextCtrl_SearchPrev(ЦелУкз сам, цел флаги, ткст текст);
    static extern (C) цел    wxStyledTextCtrl_LinesOnScreen(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_UsePopUp(ЦелУкз сам, бул allowPopUp);
    static extern (C) бул   wxStyledTextCtrl_SelectionIsRectangle(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetZoom(ЦелУкз сам, цел zoom);
    static extern (C) цел    wxStyledTextCtrl_GetZoom(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_CreateDocument(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_AddRefDocument(ЦелУкз сам, ЦелУкз docPointer);
    static extern (C) проц   wxStyledTextCtrl_ReleaseDocument(ЦелУкз сам, ЦелУкз docPointer);
    static extern (C) цел    wxStyledTextCtrl_GetModEventMask(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetSTCFocus(ЦелУкз сам, бул focus);
    static extern (C) бул   wxStyledTextCtrl_GetSTCFocus(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetStatus(ЦелУкз сам, цел statusCode);
    static extern (C) цел    wxStyledTextCtrl_GetStatus(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetMouseDownCaptures(ЦелУкз сам, бул captures);
    static extern (C) бул   wxStyledTextCtrl_GetMouseDownCaptures(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetSTCCursor(ЦелУкз сам, цел cursorType);
    static extern (C) цел    wxStyledTextCtrl_GetSTCCursor(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetControlCharSymbol(ЦелУкз сам, цел symbol);
    static extern (C) цел    wxStyledTextCtrl_GetControlCharSymbol(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_WordPartLeft(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_WordPartLeftExtend(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_WordPartRight(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_WordPartRightExtend(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetVisiblePolicy(ЦелУкз сам, цел visiblePolicy, цел visibleSlop);
    static extern (C) проц   wxStyledTextCtrl_DelLineLeft(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_DelLineRight(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetXOffset(ЦелУкз сам, цел newOffset);
    static extern (C) цел    wxStyledTextCtrl_GetXOffset(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_ChooseCaretX(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetXCaretPolicy(ЦелУкз сам, цел caretPolicy, цел caretSlop);
    static extern (C) проц   wxStyledTextCtrl_SetYCaretPolicy(ЦелУкз сам, цел caretPolicy, цел caretSlop);
    static extern (C) проц   wxStyledTextCtrl_SetPrintWrapMode(ЦелУкз сам, цел mode);
    static extern (C) цел    wxStyledTextCtrl_GetPrintWrapMode(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetHotspotActiveForeground(ЦелУкз сам, бул useУстting, ЦелУкз fore);
    static extern (C) проц   wxStyledTextCtrl_SetHotspotActiveBackground(ЦелУкз сам, бул useУстting, ЦелУкз back);
    static extern (C) проц   wxStyledTextCtrl_SetHotspotActiveUnderline(ЦелУкз сам, бул underline);
    static extern (C) проц   wxStyledTextCtrl_StartRecord(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_StopRecord(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetLexer(ЦелУкз сам, цел lexer);
    static extern (C) цел    wxStyledTextCtrl_GetLexer(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_Colourise(ЦелУкз сам, цел start, цел end);
    static extern (C) проц   wxStyledTextCtrl_SetProperty(ЦелУкз сам, ткст key, ткст значение);
    static extern (C) проц   wxStyledTextCtrl_SetKeyWords(ЦелУкз сам, цел keywordУст, ткст keyWords);
    static extern (C) проц   wxStyledTextCtrl_SetLexerLanguage(ЦелУкз сам, ткст language);
    static extern (C) цел    wxStyledTextCtrl_GetCurrentLine(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_StyleУстSpec(ЦелУкз сам, цел styleNum, ткст spec);
    static extern (C) проц   wxStyledTextCtrl_StyleУстFont(ЦелУкз сам, цел styleNum, ЦелУкз шрифт);
    static extern (C) проц   wxStyledTextCtrl_StyleУстFontAttr(ЦелУкз сам, цел styleNum, цел Размер, ткст faceName, бул bold, бул italic, бул underline);
    static extern (C) проц   wxStyledTextCtrl_CmdKeyExecute(ЦелУкз сам, цел кмд);
    static extern (C) проц   wxStyledTextCtrl_SetMargins(ЦелУкз сам, цел left, цел right);
    static extern (C) проц   wxStyledTextCtrl_GetSelection(ЦелУкз сам, inout цел startPos, inout цел endPos);
    static extern (C) проц   wxStyledTextCtrl_PointFromPosition(ЦелУкз сам, цел поз, inout Точка тчк);
    static extern (C) проц   wxStyledTextCtrl_ScrollToLine(ЦелУкз сам, цел line);
    static extern (C) проц   wxStyledTextCtrl_ScrollToColumn(ЦелУкз сам, цел column);
    static extern (C) цел    wxStyledTextCtrl_SendMsg(ЦелУкз сам, цел msg, цел wp, цел lp);
    //static extern (C) проц   wxStyledTextCtrl_SetVScrollBar(ЦелУкз сам, ЦелУкз bar);
    //static extern (C) проц   wxStyledTextCtrl_SetHScrollBar(ЦелУкз сам, ЦелУкз bar);
    static extern (C) бул   wxStyledTextCtrl_GetLastKeydownProcessed(ЦелУкз сам);
    static extern (C) проц   wxStyledTextCtrl_SetLastKeydownProcessed(ЦелУкз сам, бул val);
    static extern (C) бул   wxStyledTextCtrl_SaveFile(ЦелУкз сам, ткст имяф);
    static extern (C) бул   wxStyledTextCtrl_LoadFile(ЦелУкз сам, ткст имяф);
    //! \endcond
    ...
    public class StyledTextCtrl : Control
    {
        ...
        public  this(Окно родитель, цел ид /*= wxID_ANY*/, Точка поз = вхДефПоз, Размер Размер = вхДефРазм, цел стиль =0, ткст имя = wxSTCNameStr)
        {
            this(wxStyledTextCtrl_ctor(wxObject.SafePtr(родитель), ид, поз, Размер, cast(бцел)стиль, имя));
        }

        public static wxObject Нов(ЦелУкз wxobj)
        {
            return new StyledTextCtrl(wxobj);
        }

        //---------------------------------------------------------------------
        // ctors with сам created ид

        public  this(Окно родитель, Точка поз = вхДефПоз, Размер Размер = вхДефРазм, цел стиль =0, ткст имя = wxSTCNameStr)
        {
        ...
        public цел Length()
        {
            return wxStyledTextCtrl_GetLength(wxobj);
        }
        ...
        public цел CurrentPos()
        {
            return wxStyledTextCtrl_GetCurrentPos(wxobj);
        }
        public проц CurrentPos(цел значение)
        {
            wxStyledTextCtrl_SetCurrentPos(wxobj, значение);
        }
        ...
        public цел Anchor()
        {
            return wxStyledTextCtrl_GetAnchor(wxobj);
        }
        public проц Anchor(цел значение)
        {
            wxStyledTextCtrl_SetAnchor(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetUndoCollection(wxobj);
        }
        public проц UndoCollection(бул значение)
        {
            wxStyledTextCtrl_SetUndoCollection(wxobj, значение);
        }
        ...
        public бул CanRedo()
        {
            return wxStyledTextCtrl_CanRedo(wxobj);
        }
        ...
        {
            return wxStyledTextCtrl_GetViewWhiteSpace(wxobj);
        }
        public проц ViewWhiteSpace(цел значение)
        {
            wxStyledTextCtrl_SetViewWhiteSpace(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetEndStyled(wxobj);
        }
        ...
        public цел EOLMode()
        {
            return wxStyledTextCtrl_GetEOLMode(wxobj);
        }
        public проц EOLMode(цел значение)
        {
            wxStyledTextCtrl_SetEOLMode(wxobj, значение);
        }
        ...
        public бул BufferedDraw()
        {
            return wxStyledTextCtrl_GetBufferedDraw(wxobj);
        }
        public проц BufferedDraw(бул значение)
        {
            wxStyledTextCtrl_SetBufferedDraw(wxobj, значение);
        }
        ...
        public цел TabWidth()
        {
            return wxStyledTextCtrl_GetTabWidth(wxobj);
        }
        public проц TabWidth(цел значение)
        {
            wxStyledTextCtrl_SetTabWidth(wxobj, значение);
        }
        ...
        public цел CodePage()
        {
            return wxStyledTextCtrl_GetCodePage(wxobj);
        }
        public проц CodePage(цел значение)
        {
            wxStyledTextCtrl_SetCodePage(wxobj, значение);
        }
        ...
        {
            return new Цвет(wxStyledTextCtrl_GetCaretForeground(wxobj), да);
        }
        public проц CaretForeground(Цвет значение)
        {
            wxStyledTextCtrl_SetCaretForeground(wxobj, wxObject.SafePtr(значение));
        }
        ...
        public цел CaretPeriod()
        {
            return wxStyledTextCtrl_GetCaretPeriod(wxobj);
        }
        public проц CaretPeriod(цел значение)
        {
            wxStyledTextCtrl_SetCaretPeriod(wxobj, значение);
        }
        ...
        public цел StyleBits()
        {
            return wxStyledTextCtrl_GetStyleBits(wxobj);
        }
        public проц StyleBits(цел значение)
        {
            wxStyledTextCtrl_SetStyleBits(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetMaxLineState(wxobj);
        }
        ...
        {
            return wxStyledTextCtrl_GetCaretLineVisible(wxobj);
        }
        public проц CaretLineVisible(бул значение)
        {
            wxStyledTextCtrl_SetCaretLineVisible(wxobj, значение);
        }
        ...
        {
            return new Цвет(wxStyledTextCtrl_GetCaretLineBack(wxobj), да);
        }
        public проц CaretLineBack(Цвет значение)
        {
            wxStyledTextCtrl_SetCaretLineBack(wxobj, wxObject.SafePtr(значение));
        }
        ...
        {
            return wxStyledTextCtrl_AutoCompActive(wxobj);
        }

        public цел AutoCompPosStart()
        {
            return wxStyledTextCtrl_AutoCompPosStart(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_AutoCompStops(wxobj, значение);
        }

        public char AutoCompSeparator()
        {
            return cast(char)wxStyledTextCtrl_AutoCompGetSeparator(wxobj);
        }
        public проц AutoCompSeparator(char значение)
        {
            wxStyledTextCtrl_AutoCompУстSeparator(wxobj, cast(цел)значение);
        }
        ...
        {
            return wxStyledTextCtrl_AutoCompGetCancelAtStart(wxobj);
        }
        public проц AutoCompCancelAtStart(бул значение)
        {
            wxStyledTextCtrl_AutoCompУстCancelAtStart(wxobj, значение);
        }

        public проц AutoCompFillUps(ткст значение)
        {
            wxStyledTextCtrl_AutoCompУстFillUps(wxobj, значение);
        }

        public бул AutoCompChooseSingle()
        {
            return wxStyledTextCtrl_AutoCompGetChooseSingle(wxobj);
        }
        public проц AutoCompChooseSingle(бул значение)
        {
            wxStyledTextCtrl_AutoCompУстChooseSingle(wxobj, значение);
        }

        public бул AutoCompIgnoreCase()
        {
            return wxStyledTextCtrl_AutoCompGetIgnoreCase(wxobj);
        }
        public проц AutoCompIgnoreCase(бул значение)
        {
            wxStyledTextCtrl_AutoCompУстIgnoreCase(wxobj, значение);
        }

        public проц AutoCompAutoHide(бул значение)
        {
            wxStyledTextCtrl_AutoCompУстAutoHide(wxobj, значение);
        }
        public бул AutoCompAutoHide()
        {
            return wxStyledTextCtrl_AutoCompGetAutoHide(wxobj);
        }

        public проц AutoCompDropRestOfWord(бул значение)
        {
            wxStyledTextCtrl_AutoCompУстDropRestOfWord(wxobj, значение);
        }
        public бул AutoCompDropRestOfWord()
        {
            return wxStyledTextCtrl_AutoCompGetDropRestOfWord(wxobj);
        }

        public цел AutoCompTypeSeparator()
        {
            return wxStyledTextCtrl_AutoCompGetTypeSeparator(wxobj);
        }
        public проц AutoCompTypeSeparator(цел значение)
        {
            wxStyledTextCtrl_AutoCompУстTypeSeparator(wxobj, значение);
        }
        ...
        public цел Indent()
        {
            return wxStyledTextCtrl_GetIndent(wxobj);
        }
        public проц Indent(цел значение)
        {
            wxStyledTextCtrl_SetIndent(wxobj, значение);
        }
        ...
        public бул UseTabs()
        {
            return wxStyledTextCtrl_GetUseTabs(wxobj);
        }
        public проц UseTabs(бул значение)
        {
            wxStyledTextCtrl_SetUseTabs(wxobj, значение);
        }
        ...
        public проц UseHorizontalScrollBar(бул значение)
        {
            wxStyledTextCtrl_SetUseHorizontalScrollBar(wxobj, значение);
        }
        public бул UseHorizontalScrollBar()
        {
            return wxStyledTextCtrl_GetUseHorizontalScrollBar(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_SetIndentationGuides(wxobj, значение);
        }
        public бул IndentationGuides()
        {
            return wxStyledTextCtrl_GetIndentationGuides(wxobj);
        }
        ...
        {
            return wxStyledTextCtrl_GetHighlightGuide(wxobj);
        }
        public проц HighlightGuide(цел значение)
        {
            wxStyledTextCtrl_SetHighlightGuide(wxobj, значение);
        }
        ...
        public бул ReadOnly()
        {
            return wxStyledTextCtrl_GetReadOnly(wxobj);
        }
        public проц ReadOnly(бул значение)
        {
            wxStyledTextCtrl_SetReadOnly(wxobj, значение);
        }

        //-----------------------------------------------------------------------------

        public цел SelectionStart()
        {
            return wxStyledTextCtrl_GetSelectionStart(wxobj);
        }
        public проц SelectionStart(цел значение)
        {
            wxStyledTextCtrl_SetSelectionStart(wxobj, значение);
        }

        public цел SelectionEnd()
        {
            return wxStyledTextCtrl_GetSelectionEnd(wxobj);
        }
        public проц SelectionEnd(цел значение)
        {
            wxStyledTextCtrl_SetSelectionEnd(wxobj, значение);
        }

        //-----------------------------------------------------------------------------

        public цел PrintMagnification()
        {
            return wxStyledTextCtrl_GetPrintMagnification(wxobj);
        }
        public проц PrintMagnification(цел значение)
        {
            wxStyledTextCtrl_SetPrintMagnification(wxobj, значение);
        }

        public цел PrintColourMode()
        {
            return wxStyledTextCtrl_GetPrintColourMode(wxobj);
        }
        public проц PrintColourMode(цел значение)
        {
            wxStyledTextCtrl_SetPrintColourMode(wxobj, значение);
        }
        ...
        public цел FirstVisibleLine()
        {
            return wxStyledTextCtrl_GetFirstVisibleLine(wxobj);
        }
        ...
        {
            return wxStyledTextCtrl_GetLineCount(wxobj);
        }

        //-----------------------------------------------------------------------------

        public цел MarginLeft()
        {
            return wxStyledTextCtrl_GetMarginLeft(wxobj);
        }
        public проц MarginLeft(цел значение)
        {
            wxStyledTextCtrl_SetMarginLeft(wxobj, значение);
        }

        public цел MarginRight()
        {
            return wxStyledTextCtrl_GetMarginRight(wxobj);
        }
        public проц MarginRight(цел значение)
        {
            wxStyledTextCtrl_SetMarginRight(wxobj, значение);
        }
        ...
        public бул Modify()
        {
            return wxStyledTextCtrl_GetModify(wxobj);
        }
        ...
        public ткст SelectedText()
        {
            return cast(ткст) new wxString(wxStyledTextCtrl_GetSelectedText(wxobj), да);
        }
        ...
        public проц HideSelection(бул значение)
        {
            wxStyledTextCtrl_HideSelection(wxobj, значение);
        }
        ...
        public бул CanPaste()
        {
            return wxStyledTextCtrl_CanPaste(wxobj);
        }

        public бул CanUndo()
        {
            return wxStyledTextCtrl_CanUndo(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_SetText(wxobj, значение);
        }
        public ткст Text()
        {
            return cast(ткст) new wxString(wxStyledTextCtrl_GetText(wxobj), да);
        }
        ...
        {
            return wxStyledTextCtrl_GetTextLength(wxobj);
        }
        ...
        public бул Overtype()
        {
            return wxStyledTextCtrl_GetOvertype(wxobj);
        }
        public проц Overtype(бул значение)
        {
            wxStyledTextCtrl_SetOvertype(wxobj, значение);
        }

        //-----------------------------------------------------------------------------

        public цел CaretWidth()
        {
            return wxStyledTextCtrl_GetCaretWidth(wxobj);
        }
        public проц CaretWidth(цел значение)
        {
            wxStyledTextCtrl_SetCaretWidth(wxobj, значение);
        }

        //-----------------------------------------------------------------------------

        public цел TargetStart()
        {
            return wxStyledTextCtrl_GetTargetStart(wxobj);
        }
        public проц TargetStart(цел значение)
        {
            wxStyledTextCtrl_SetTargetStart(wxobj, значение);
        }

        public цел TargetEnd()
        {
            return wxStyledTextCtrl_GetTargetEnd(wxobj);
        }
        public проц TargetEnd(цел значение)
        {
            wxStyledTextCtrl_SetTargetEnd(wxobj, значение);
        }
        ...
        public цел УстSearchФлаги()
        {
            return wxStyledTextCtrl_GetSearchФлаги(wxobj);
        }
        public проц УстSearchФлаги(цел значение)
        {
            wxStyledTextCtrl_SetSearchФлаги(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_CallTipActive(wxobj);
        }

        public цел CallTipPosAtStart()
        {
            return wxStyledTextCtrl_CallTipPosAtStart(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_CallTipУстBackground(wxobj, wxObject.SafePtr(значение));
        }

        public проц CallTipForeground(Цвет значение)
        {
            wxStyledTextCtrl_CallTipУстForeground(wxobj, wxObject.SafePtr(значение));
        }

        public проц CallTipForegroundHighlight(Цвет значение)
        {
            wxStyledTextCtrl_CallTipУстForegroundHighlight(wxobj, wxObject.SafePtr(значение));
        }
        ...
        {
            wxStyledTextCtrl_SetFoldФлаги(wxobj, значение);
        }
        ...
        public бул TabIndents()
        {
            return wxStyledTextCtrl_GetTabIndents(wxobj);
        }
        public проц TabIndents(бул значение)
        {
            wxStyledTextCtrl_SetTabIndents(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetBackSpaceUnIndents(wxobj);
        }
        public проц BackSpaceUnIndents(бул значение)
        {
            wxStyledTextCtrl_SetBackSpaceUnIndents(wxobj, значение);
        }
        ...
        {
            wxStyledTextCtrl_SetMouseDwellTime(wxobj, значение);
        }
        public цел MouseDwellTime()
        {
            return wxStyledTextCtrl_GetMouseDwellTime(wxobj);
        }
        ...
        public цел WrapMode()
        {
            return wxStyledTextCtrl_GetWrapMode(wxobj);
        }
        public проц WrapMode(цел значение)
        {
            wxStyledTextCtrl_SetWrapMode(wxobj, значение);
        }
        ...
        {
            wxStyledTextCtrl_SetLayoutCache(wxobj, значение);
        }
        public цел LayoutCache()
        {
            return wxStyledTextCtrl_GetLayoutCache(wxobj);
        }
        ...
        {
            return wxStyledTextCtrl_GetScrollWidth(wxobj);
        }
        public проц ScrollWidth(цел значение)
        {
            wxStyledTextCtrl_SetScrollWidth(wxobj, значение);
        }
        ...
        {
            return cast(бул)wxStyledTextCtrl_GetEndAtLastLine(wxobj);
        }
        public проц EndAtLastLine(бул значение)
        {
            wxStyledTextCtrl_SetEndAtLastLine(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetUseVerticalScrollBar(wxobj);
        }
        public проц UseVerticalScrollBar(бул значение)
        {
            wxStyledTextCtrl_SetUseVerticalScrollBar(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetTwoPhaseDraw(wxobj);
        }
        public проц TwoPhaseDraw(бул значение)
        {
            wxStyledTextCtrl_SetTwoPhaseDraw(wxobj, значение);
        }
        ...
        public бул ViewEOL()
        {
            return wxStyledTextCtrl_GetViewEOL(wxobj);
        }
        public проц ViewEOL(бул значение)
        {
            wxStyledTextCtrl_SetViewEOL(wxobj, значение);
        }
        ...
        public wxObject DocPointer()
        {
            return НайдиОбъект(wxStyledTextCtrl_GetDocPointer(wxobj));
        }
        public проц DocPointer(wxObject значение)
        {
            wxStyledTextCtrl_SetDocPointer(wxobj, wxObject.SafePtr(значение));
        }
        ...
        {
            return wxStyledTextCtrl_GetModEventMask(wxobj);
        }
        public проц ModEventMask(цел значение)
        {
            wxStyledTextCtrl_SetModEventMask(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetEdgeColumn(wxobj);
        }
        public проц EdgeColumn(цел значение)
        {
            wxStyledTextCtrl_SetEdgeColumn(wxobj, значение);
        }
        ...
        public цел EdgeMode()
        {
            return wxStyledTextCtrl_GetEdgeMode(wxobj);
        }
        public проц EdgeMode(цел значение)
        {
            wxStyledTextCtrl_SetEdgeMode(wxobj, значение);
        }
        ...
        {
            return new Цвет(wxStyledTextCtrl_GetEdgeColour(wxobj), да);
        }
        public проц EdgeColour(Цвет значение)
        {
            wxStyledTextCtrl_SetEdgeColour(wxobj, wxObject.SafePtr(значение));
        }
        ...
        {
            return wxStyledTextCtrl_LinesOnScreen(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_UsePopUp(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_SelectionIsRectangle(wxobj);
        }
        ...
        public цел Zoom()
        {
            return wxStyledTextCtrl_GetZoom(wxobj);
        }
        public проц Zoom(цел значение)
        {
            wxStyledTextCtrl_SetZoom(wxobj, значение);
        }
        ...
        public бул STCFocus()
        {
            return wxStyledTextCtrl_GetSTCFocus(wxobj);
        }
        public проц STCFocus(бул значение)
        {
            wxStyledTextCtrl_SetSTCFocus(wxobj, значение);
        }
        ...
        public цел Status()
        {
            return wxStyledTextCtrl_GetStatus(wxobj);
        }
        public проц Status(цел значение)
        {
            wxStyledTextCtrl_SetStatus(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_GetMouseDownCaptures(wxobj);
        }
        public проц MouseDownCaptures(бул значение)
        {
            wxStyledTextCtrl_SetMouseDownCaptures(wxobj, значение);
        }
        ...
        {
            wxStyledTextCtrl_SetSTCCursor(wxobj, значение);
        }
        public цел STCCursor()
        {
            return wxStyledTextCtrl_GetSTCCursor(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_SetControlCharSymbol(wxobj, значение);
        }
        public цел ControlCharSymbol()
        {
            return wxStyledTextCtrl_GetControlCharSymbol(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_SetXOffset(wxobj, значение);
        }
        public цел XOffset()
        {
            return wxStyledTextCtrl_GetXOffset(wxobj);
        }
        ...
        {
            wxStyledTextCtrl_SetPrintWrapMode(wxobj, значение);
        }
        public цел PrintWrapMode()
        {
            return wxStyledTextCtrl_GetPrintWrapMode(wxobj);
        }
        ...
        public проц Lexer(цел значение)
        {
            wxStyledTextCtrl_SetLexer(wxobj, значение);
        }
        public цел Lexer()
        {
            return wxStyledTextCtrl_GetLexer(wxobj);
        }
        ...
        public проц LexerLanguage(ткст значение)
        {
            wxStyledTextCtrl_SetLexerLanguage(wxobj, значение);
        }

        //-----------------------------------------------------------------------------

        public цел CurrentLine()
        {
            return wxStyledTextCtrl_GetCurrentLine(wxobj);
        }
        ...
        public проц StyleУстFontAttr(цел styleNum, цел Размер, ткст faceName, бул bold, бул italic, бул underline)
        {
            wxStyledTextCtrl_StyleУстFontAttr(wxobj, styleNum, Размер, faceName, bold, italic, underline);
        }
        ...
        {
            return wxStyledTextCtrl_GetLastKeydownProcessed(wxobj);
        }
        public проц LastKeydownProcessed(бул значение)
        {
            wxStyledTextCtrl_SetLastKeydownProcessed(wxobj, значение);
        }
        ...
        {
            return wxStyledTextCtrl_SaveFile(wxobj, имяф);
        }

        public бул ЗагрузиФайл(ткст имяф)
        {
            return wxStyledTextCtrl_LoadFile(wxobj, имяф);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_CHANGE, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_STYLENEEDED, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_CHARADDED, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_SAVEPOINTREACHED, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_SAVEPOINTLEFT, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_ROMODIFYATTEMPT, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_KEY, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_DOUBLECLICK, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_UPDATEUI, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_MODIFIED, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_MACRORECORD, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_MARGINCLICK, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_NEEDSHOWN, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_PAINTED, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_USERLISTSELECTION, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_URIDROPPED, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_DWELLSTART, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_DWELLEND, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_START_DRAG, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_DRAG_OVER, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_DO_DROP, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_ZOOM, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_HOTSPOT_CLICK, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_HOTSPOT_DCLICK, ИД, значение, this);
        }
        ...
        {
            AddCommandListener(wxEVT_STC_CALLTIP_CLICK, ИД, значение, this);
        }
    ...
    //! \cond EXTERN
    static extern (C) ЦелУкз wxStyledTextEvent_ctor(цел типКоманды, цел ид);
    static extern (C) проц   wxStyledTextEvent_SetPosition(ЦелУкз сам, цел поз);
    static extern (C) проц   wxStyledTextEvent_SetKey(ЦелУкз сам, цел k);
    static extern (C) проц   wxStyledTextEvent_SetModifiers(ЦелУкз сам, цел m);
    static extern (C) проц   wxStyledTextEvent_SetModificationType(ЦелУкз сам, цел t);
    static extern (C) проц   wxStyledTextEvent_SetText(ЦелУкз сам, ткст t);
    static extern (C) проц   wxStyledTextEvent_SetLength(ЦелУкз сам, цел len);
    static extern (C) проц   wxStyledTextEvent_SetLinesAdded(ЦелУкз сам, цел чис);
    static extern (C) проц   wxStyledTextEvent_SetLine(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetFoldLevelNow(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetFoldLevelPrev(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetMargin(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetMessage(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetWParam(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetLParam(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetListType(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetX(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetY(ЦелУкз сам, цел val);
    static extern (C) проц   wxStyledTextEvent_SetDragText(ЦелУкз сам, ткст val);
    static extern (C) проц   wxStyledTextEvent_SetDragAllowMove(ЦелУкз сам, бул val);
    //static extern (C) проц   wxStyledTextEvent_SetDragResult(ЦелУкз сам, wxDragResult val);
    static extern (C) цел    wxStyledTextEvent_GetPosition(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetKey(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetModifiers(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetModificationType(ЦелУкз сам);
    static extern (C) ЦелУкз wxStyledTextEvent_GetText(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetLength(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetLinesAdded(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetLine(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetFoldLevelNow(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetFoldLevelPrev(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetMargin(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetMessage(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetWParam(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetLParam(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetListType(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetX(ЦелУкз сам);
    static extern (C) цел    wxStyledTextEvent_GetY(ЦелУкз сам);
    static extern (C) ЦелУкз wxStyledTextEvent_GetDragText(ЦелУкз сам);
    static extern (C) бул   wxStyledTextEvent_GetDragAllowMove(ЦелУкз сам);
    //static extern (C) ЦелУкз wxStyledTextEvent_GetDragResult(ЦелУкз сам);
    static extern (C) бул   wxStyledTextEvent_GetShift(ЦелУкз сам);
    static extern (C) бул   wxStyledTextEvent_GetControl(ЦелУкз сам);
    static extern (C) бул   wxStyledTextEvent_GetAlt(ЦелУкз сам);
    //! \endcond
    ...
    public class StyledTextEvent : СобытиеКоманда
    {
        ...
        public цел Позиция()
        {
            return wxStyledTextEvent_GetPosition(wxobj);
        }
        public проц Позиция(цел значение)
        {
            wxStyledTextEvent_SetPosition(wxobj, значение);
        }
        ...
        public цел Key()
        {
            return wxStyledTextEvent_GetKey(wxobj);
        }
        public проц Key(цел значение)
        {
            wxStyledTextEvent_SetKey(wxobj, значение);
        }

        //-----------------------------------------------------------------------------

        public проц Modifiers(цел значение)
        {
            wxStyledTextEvent_SetModifiers(wxobj, значение);
        }
        public цел Modifiers()
        {
            return wxStyledTextEvent_GetModifiers(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц ModificationType(цел значение)
        {
            wxStyledTextEvent_SetModificationType(wxobj, значение);
        }
        public цел ModificationType()
        {
            return wxStyledTextEvent_GetModificationType(wxobj);
        }
        ...
        public проц Text(ткст значение)
        {
            wxStyledTextEvent_SetText(wxobj, значение);
        }
        public ткст Text()
        {
            return cast(ткст) new wxString(wxStyledTextEvent_GetText(wxobj), да);
        }

        //-----------------------------------------------------------------------------

        public проц Length(цел значение)
        {
            wxStyledTextEvent_SetLength(wxobj, значение);
        }
        public цел Length()
        {
            return wxStyledTextEvent_GetLength(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц LinesAdded(цел значение)
        {
            wxStyledTextEvent_SetLinesAdded(wxobj, значение);
        }
        public цел LinesAdded()
        {
            return wxStyledTextEvent_GetLinesAdded(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц Line(цел значение)
        {
            wxStyledTextEvent_SetLine(wxobj, значение);
        }
        public цел Line()
        {
            return wxStyledTextEvent_GetLine(wxobj);
        }
        ...
        {
            wxStyledTextEvent_SetFoldLevelNow(wxobj, значение);
        }
        public цел FoldLevelNow()
        {
            return wxStyledTextEvent_GetFoldLevelNow(wxobj);
        }

        public проц FoldLevelPrev(цел значение)
        {
            wxStyledTextEvent_SetFoldLevelPrev(wxobj, значение);
        }
        public цел FoldLevelPrev()
        {
            return wxStyledTextEvent_GetFoldLevelPrev(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц Margin(цел значение)
        {
            wxStyledTextEvent_SetMargin(wxobj, значение);
        }
        public цел Margin()
        {
            return wxStyledTextEvent_GetMargin(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц Message(цел значение)
        {
            wxStyledTextEvent_SetMessage(wxobj, значение);
        }
        public цел Message()
        {
            return wxStyledTextEvent_GetMessage(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц WParam(цел значение)
        {
            wxStyledTextEvent_SetWParam(wxobj, значение);
        }
        public цел WParam()
        {
            return wxStyledTextEvent_GetWParam(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц LParam(цел значение)
        {
            wxStyledTextEvent_SetLParam(wxobj, значение);
        }
        public цел LParam()
        {
            return wxStyledTextEvent_GetLParam(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц ListType(цел значение)
        {
            wxStyledTextEvent_SetListType(wxobj, значение);
        }
        public цел ListType()
        {
            return wxStyledTextEvent_GetListType(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц X(цел значение)
        {
            wxStyledTextEvent_SetX(wxobj, значение);
        }
        public цел X()
        {
            return wxStyledTextEvent_GetX(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц Y(цел значение)
        {
            wxStyledTextEvent_SetY(wxobj, значение);
        }
        public цел Y()
        {
            return wxStyledTextEvent_GetY(wxobj);
        }

        //-----------------------------------------------------------------------------

        public проц DragText(ткст значение)
        {
            wxStyledTextEvent_SetDragText(wxobj, значение);
        }
        public ткст DragText()
        {
            return cast(ткст) new wxString(wxStyledTextEvent_GetDragText(wxobj), да);
        }
        ...
        {
            wxStyledTextEvent_SetDragAllowMove(wxobj, значение);
        }
        public бул DragAllowMove()
        {
            return wxStyledTextEvent_GetDragAllowMove(wxobj);
        }
        ...
        public бул Shift()
        {
            return wxStyledTextEvent_GetShift(wxobj);
        }

        public бул Control()
        {
            return wxStyledTextEvent_GetControl(wxobj);
        }

        public бул Alt()
        {
            return wxStyledTextEvent_GetAlt(wxobj);
        }

        private static Событие Нов(ЦелУкз объ)
        {
            return new StyledTextEvent(объ);
        }
    }
