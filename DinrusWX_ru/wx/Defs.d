...
//
// $Ид: Defs.d,v 1.12 2007/10/24 07:50:09 afb Exp $
//-----------------------------------------------------------------------------
...
version(wx28) // -------------------------------------------- wxWidgets 2.8
{
    ...
    public enum MenuIDs
    {
        ...
        /*  IDs used by generic file dialog (13 consecutive starting from this значение) */
        wxID_FILEDLGG = 5900,
...
enum
{
    /** no ид matches this one when compared to it */
    wxID_NONE = -3,

    /**  ид for a separator line in the меню (invalid for normal элт) */
    wxID_SEPARATOR = -2,

    /** any ид: means that we don't care about the ид, whether when installing
      * an event обработчик or when creating a new окно */
    wxID_ANY = -1,
