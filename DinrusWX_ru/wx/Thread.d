...
//! \cond EXTERN
static extern (C) ЦелУкз wxMutex_ctor(цел mutexType);
static extern (C) проц wxMutex_dtor(ЦелУкз сам);
static extern (C) бул wxMutex_IsOk(ЦелУкз сам);
//! \endcond
...
//! \cond EXTERN
static extern (C) ЦелУкз wxCriticalSection_ctor(цел mutexType);
static extern (C) проц wxCriticalSection_dtor(ЦелУкз сам);
static extern (C) проц wxCriticalSection_Enter(ЦелУкз сам);
static extern (C) проц wxCriticalSection_Leave(ЦелУкз сам);
//! \endcond
