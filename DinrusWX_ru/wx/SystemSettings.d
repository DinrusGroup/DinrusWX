//-----------------------------------------------------------------------------
// wxD - SystemУстtings.d
// (C) 2005 bero <berobero@users.sourceforge.net>
// based on
// wx.NET - SystemУстtings.cs
//
/// The wxSystemУстtings wrapper class.
//
// Written by Bryan Bulten (bryan@bulten.ca)
// (C) 2003 Bryan Bulten
// Licensed under the wxWidgets license, see LICENSE.txt for details.
//
// $Ид: SystemУстtings.d,v 1.9 2006/11/17 15:21:01 afb Exp $
//-----------------------------------------------------------------------------
...
static extern (C) ЦелУкз wxSystemУстtings_GetColour(цел index);
static extern (C) ЦелУкз wxSystemУстtings_GetFont(цел index);
...
public class SystemУстtings
{
    ...
    {
        return new Цвет(wxSystemУстtings_GetColour(cast(цел)index), да);
    }
    ...
    {
        return new Шрифт(wxSystemУстtings_GetFont(cast(цел)index));
    }
    ...
    {
        return wxSystemУстtings_GetMetric(cast(цел)index);
    }
    ...
    {
        return wxSystemУстtings_HasFeature(cast(цел)index);
    }
    ...
    {
        return cast(SystemScreenType)wxSystemУстtings_GetScreenType();
    }
    static проц ScreenType(SystemScreenType значение)
    {
        wxSystemУстtings_SetScreenType(cast(цел)значение);
    }
