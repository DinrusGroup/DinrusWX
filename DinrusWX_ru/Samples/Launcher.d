...
private import std.c;
	...
	public class LauncherFrame : Frame
	{
		...
		public this( ткст title, Точка поз, Размер Размер )
		{
			...
			БоксСайзер bs = new БоксСайзер( Ориентация.wxVERTICAL );
	...
	public class TopHtmlWindow : HtmlWindow
	{
		...
		{
			super( родитель, -1, вхДефПоз, Размер( 400, 144 ) );
			LoadPage( "./data/launchertop.html" );
		}
	}
	...
	public class BottomHtmlWindow : HtmlWindow
	{
		...
		public this( LauncherFrame родитель )
		{
			super( родитель, -1, вхДефПоз, Размер( 400, 80 ) );
			this.родитель = родитель;
			LoadPage( "./data/launcherbottom.html" );
		}
	...
	public class MiddleHtmlWindow : HtmlWindow
	{
		...
		public this( LauncherFrame родитель )
		{
			...
			LoadPage( "./data/wxDSamplesLauncher.html" );
		}
