...
//
// $Id: bitmapbutton.cpp,v 1.11 2007/01/28 23:06:38 afb Exp $
//-----------------------------------------------------------------------------
...
extern "C" WXEXPORT
wxBitmapButton* wxBitmapButton_NewCloseButton(_BitmapButton* self, wxWindow* parent, wxWindowID winid)
{
	return self->NewCloseButton(parent, winid);
}
