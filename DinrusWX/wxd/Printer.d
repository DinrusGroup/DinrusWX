...
public class Printer : wxObject
{
    ...
    {
        return cast(PrintDialogData)FindObject(wxPrinter_GetPrintDialogData(wxobj), &PrintDialogData.New);
    }
...
//	public static wxObject New(IntPtr ptr) { return new Printout(ptr); }
    ...
    public string Title()
    {
        return cast(string) new wxString(wxPrintout_GetTitle(wxobj), true);
    }
    ...
    public DC Dc()
    {
        return cast(DC)FindObject(wxPrintout_GetDC(wxobj), &DC.New);
    }
    public void Dc(DC value)
    {
        wxPrintout_SetDC(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxPrintout_SetIsPreview(wxobj, value);
    }
}
