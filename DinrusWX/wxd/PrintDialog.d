...
public class PageSetupDialog : Dialog
{
    ...
    {
        return cast(PageSetupDialogData)FindObject(wxPageSetupDialog_GetPageSetupData(wxobj), &PageSetupDialogData.New);
    }
}
...
public class PrintDialog : Dialog
{
    ...
    {
        return cast(PrintData)FindObject(wxPrintDialog_GetPrintData(wxobj), &PrintData.New);
    }
    ...
    {
        return cast(PrintDialogData)FindObject(wxPrintDialog_GetPrintDialogData(wxobj), &PrintDialogData.New);
    }
    ...
    public DC PrintDC()
    {
        return cast(DC)FindObject(wxPrintDialog_GetPrintDC(wxobj), &DC.New);
    }
}
...
version(none) /*(__WXGTK__)*/
{
    ...
    public class PrintSetupDialog : Dialog
    {
        ...
        public PrintData printData()
        {
            return cast(PrintData)FindObject(wxPrintSetupDialog_GetPrintData(wxobj), &PrintData.New);
        }
    }
