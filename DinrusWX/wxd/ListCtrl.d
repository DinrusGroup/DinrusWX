...
//
// $Id: ListCtrl.d,v 1.12 2007/11/27 08:19:20 afb Exp $
//-----------------------------------------------------------------------------
...
public class ListItem : wxObject
{
    ...
    {
        wxListItem_SetAlign(wxobj, value);
    }
    ...
    {
        return new Colour(wxListItem_GetBackgroundColour(wxobj), true);
    }
    public void BackgroundColour(Colour value)
    {
        wxListItem_SetBackgroundColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxListItem_SetColumn(wxobj, value);
    }
    ...
    {
        return cast(ClientData)FindObject(wxListItem_GetData(wxobj));
    }
    public void Data(ClientData value)
    {
        wxListItem_SetData(wxobj, wxObject.SafePtr(value));
    }
    ...
    public Font font()
    {
        return new Font(wxListItem_GetFont(wxobj));
    }
    public void font(Font value)
    {
        wxListItem_SetFont(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxListItem_SetImage(wxobj, value);
    }
    ...
    {
        wxListItem_SetMask(wxobj, value);
    }
    ...
    {
        wxListItem_SetState(wxobj, value);
    }

    public void StateMask(int value)
    {
        wxListItem_SetStateMask(wxobj, value);
    }
    ...
    public string Text()
    {
        return cast(string) new wxString(wxListItem_GetText(wxobj), true);
    }
    public void Text(string value)
    {
        wxListItem_SetText(wxobj, value);
    }
    ...
    {
        return new Colour(wxListItem_GetTextColour(wxobj), true);
    }
    public void TextColour(Colour value)
    {
        wxListItem_SetTextColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxListItem_SetWidth(wxobj, value);
    }
    ...
    {
        return cast(ListItemAttr)FindObject(wxListItem_GetAttributes(wxobj), &ListItemAttr.New);
    }
...
public class ListItemAttr : wxObject
{
    ...
    public Colour TextColour()
    {
        return new Colour(wxListItemAttr_GetTextColour(wxobj), true);
    }
    public void TextColour(Colour value)
    {
        wxListItemAttr_SetTextColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    public Colour BackgroundColour()
    {
        return new Colour(wxListItemAttr_GetBackgroundColour(wxobj), true);
    }
    public void BackgroundColour(Colour value)
    {
        wxListItemAttr_SetBackgroundColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    public Font font()
    {
        return new Font(wxListItemAttr_GetFont(wxobj), true);
    }
    public void font(Font value)
    {
        wxListItemAttr_SetFont(wxobj, wxObject.SafePtr(value));
    }
...
public class ListCtrl : Control
{
    ...
    {
        wxListCtrl_SetItemCount(wxobj, value);
    }
    ...
    public Colour TextColour()
    {
        return new Colour(wxListCtrl_GetTextColour(wxobj), true);
    }
    public void TextColour(Colour value)
    {
        wxListCtrl_SetTextColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxListCtrl_SetWindowStyleFlag(wxobj, cast(uint)value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_BEGIN_DRAG, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_BEGIN_RDRAG, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_BEGIN_LABEL_EDIT, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_END_LABEL_EDIT, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_DELETE_ITEM, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_DELETE_ALL_ITEMS, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_GET_INFO, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_SET_INFO, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_ITEM_SELECTED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_ITEM_DESELECTED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_ITEM_ACTIVATED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_ITEM_FOCUSED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_ITEM_MIDDLE_CLICK, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_ITEM_RIGHT_CLICK, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_KEY_DOWN, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_INSERT_ITEM, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_COL_CLICK, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_COL_RIGHT_CLICK, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_COL_BEGIN_DRAG, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_COL_DRAGGING, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_COL_END_DRAG, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LIST_CACHE_HINT, ID, value, this);
    }
...
public class ListEvent : Event
{
    ...
    public string Label()
    {
        return cast(string) new wxString(wxListEvent_GetLabel(wxobj), true);
    }
    ...
    public string Text()
    {
        return cast(string) new wxString(wxListEvent_GetText(wxobj), true);
    }
    ...
    {
        wxListEvent_SetEditCanceled(wxobj, value);
    }
...
public class ListView : ListCtrl
{
    ...
    {
        return cast(int)wxListView_GetFocusedItem(wxobj);
    }
    ...
    {
        return cast(int)wxListView_GetFirstSelected(wxobj);
    }
