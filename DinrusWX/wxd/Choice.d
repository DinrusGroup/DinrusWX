...
public class Choice : Control, IControlWithItems
{
    ...
    {
        wxChoice_SetSelection(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxChoice_GetStringSelection(wxobj), true);
    }
    public void StringSelection(string value)
    {
        wxChoice_SetStringSelection(wxobj, value);
    }
    ...
    {
        wxChoice_SetColumns(wxobj, value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_CHOICE_SELECTED, ID, value, this);
    }
