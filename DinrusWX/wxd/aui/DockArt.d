...
public class DockArt : wxObject
{
    ...
    {
        return wxObject.SafePtr(obj.GetFont(id));
    }
    extern (C) protected static IntPtr staticGetColour(DockArt obj, int id)
    {
        return wxObject.SafePtr(obj.GetColour(id));
    }
    ...
    {
        return wxObject.SafePtr(obj.GetColor(id));
    }
    ...
    {
        return wxDockArt_GetMetric(wxobj, id);
    }
    public void SetMetric(int id, int new_val)
    {
        wxDockArt_SetMetric(wxobj, id, new_val);
    }
    public void SetFont(int id, wxFont font)
    {
        wxDockArt_SetFont(wxobj, id, wxObject.SafePtr(font));
    }
    ...
    {
        wxDockArt_SetColour(wxobj, id, wxObject.SafePtr(colour));
    }
    ...
    {
        wxDockArt_SetColor(wxobj, id, wxObject.SafePtr(color));
    }
    public void DrawSash(DC dc, int orientation, Rectangle rect)
    {
        wxDockArt_DrawSash(wxobj, wxObject.SafePtr(dc), orientation, rect);
    }
    public void DrawBackground(DC dc, int orientation, Rectangle rect)
    {
        wxDockArt_DrawBackground(wxobj, wxObject.SafePtr(dc), orientation, rect);
    }
    public void DrawCaption(DC dc, string text, Rectangle rect, PaneInfo pane)
    {
        wxDockArt_DrawCaption(wxobj, wxObject.SafePtr(dc), text, rect, wxObject.SafePtr(pane));
    }
    public void DrawGripper(DC dc, Rectangle rect, PaneInfo pane)
    {
        wxDockArt_DrawGripper(wxobj, wxObject.SafePtr(dc), rect, wxObject.SafePtr(pane));
    }
    public void DrawBorder(DC dc, Rectangle rect, PaneInfo pane)
    {
        wxDockArt_DrawBorder(wxobj, wxObject.SafePtr(dc), rect, wxObject.SafePtr(pane));
    }
    public void DrawPaneButton(DC dc, int button, int button_state, Rectangle rect, PaneInfo pane)
    {
        wxDockArt_DrawPaneButton(wxobj, wxObject.SafePtr(dc), button, button_state, rect, wxObject.SafePtr(pane));
    }
}
