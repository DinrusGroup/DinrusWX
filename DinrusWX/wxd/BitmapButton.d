...
public class BitmapButton : Control
{
    ...
    public this(Window parent, int id, Bitmap label, Point pos, Size size, int style, Validator validator, string name)
    {
        ...
        {
            throw new InvalidOperationException("Не удалось создать BitmapButton");
        }
    }

    public static wxObject New(IntPtr wxobj)
    {
        return new BitmapButton(wxobj);
    }
    ...
    {
        wxBitmapButton_SetLabel(wxobj, value);
    }
    ...
    {
        return cast(Bitmap)FindObject(wxBitmapButton_GetBitmapLabel(wxobj), &Bitmap.New);
    }
    public void BitmapLabel(Bitmap value)
    {
        wxBitmapButton_SetBitmapLabel(wxobj, wxObject.SafePtr(value));
    }
    /+
    public Bitmap Label()
    {
    ...
    {
        return cast(Bitmap)FindObject(wxBitmapButton_GetBitmapSelected(wxobj), &Bitmap.New);
    }
    public void BitmapSelected(Bitmap value)
    {
        wxBitmapButton_SetBitmapSelected(wxobj, wxObject.SafePtr(value));
    }

    public Bitmap BitmapFocus()
    {
        return cast(Bitmap)FindObject(wxBitmapButton_GetBitmapFocus(wxobj), &Bitmap.New);
    }
    public void BitmapFocus(Bitmap value)
    {
        wxBitmapButton_SetBitmapFocus(wxobj, wxObject.SafePtr(value));
    }

    public Bitmap BitmapDisabled()
    {
        return cast(Bitmap)FindObject(wxBitmapButton_GetBitmapDisabled(wxobj), &Bitmap.New);
    }
