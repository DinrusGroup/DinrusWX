...
public class Pen : GDIObject
{
    ...
    {
        return cast(Colour)FindObject(wxPen_GetColour(wxobj), &Colour.New);
    }
    public void colour(Colour value)
    {
        wxPen_SetColour(wxobj, wxObject.SafePtr(value));
    }
