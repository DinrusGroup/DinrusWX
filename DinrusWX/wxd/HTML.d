...
public class HtmlTag : wxObject
{
    ...
    {
        return cast(HtmlTag)FindObject(ptr, &HtmlTag.New);
    }
    ...
    public string Name()
    {
        return cast(string) new wxString(wxHtmlTag_GetName(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxHtmlTag_GetAllParams(wxobj), true);
    }
...
public class HtmlCell : wxObject
{
    ...
    {
        return cast(HtmlCell)FindObject(ptr, &HtmlCell.New);
    }
    ...
    {
        wxHtmlCell_SetParent(wxobj, wxObject.SafePtr(value));
    }
    public HtmlContainerCell Parent()
    {
        return cast(HtmlContainerCell)FindObject(wxHtmlCell_GetParent(wxobj), &HtmlContainerCell.New);
    }
    ...
    {
        return cast(string) new wxString(wxHtmlCell_GetId(wxobj), true);
    }
    public /+virtual+/ void Id(string value)
    {
        wxHtmlCell_SetId(wxobj, value);
    }
    ...
    {
        return cast(HtmlCell)FindObject(wxHtmlCell_GetNext(wxobj), &HtmlCell.New);
    }
    public void Next(HtmlCell value)
    {
        wxHtmlCell_SetNext(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxHtmlCell_SetLink(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxHtmlCell_SetCanLiveOnPagebreak(wxobj, value);
    }
...
public class HtmlContainerCell : HtmlCell
{
    ...
    {
        wxHtmlContainerCell_SetAlignHor(wxobj, value);
    }
    public int AlignHor()
    {
    ...
    {
        wxHtmlContainerCell_SetAlignVer(wxobj, value);
    }
    public int AlignVer()
    {
    ...
    {
        wxHtmlContainerCell_SetAlign(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxHtmlContainerCell_SetBackgroundColour(wxobj, wxObject.SafePtr(value));
    }
    public Colour BackgroundColour()
    {
        return new Colour(wxHtmlContainerCell_GetBackgroundColour(wxobj), true);
    }
...
public class HtmlLinkInfo : wxObject
{
    ...
    {
        wxHtmlLinkInfo_SetEvent(wxobj, wxObject.SafePtr(value));
    }
    public MouseEvent event()
    {
        return cast(MouseEvent)FindObject(wxHtmlLinkInfo_GetEvent(wxobj), cast(wxObject function (IntPtr))&MouseEvent.New);
    }
    ...
    public string Href()
    {
        return cast(string) new wxString(wxHtmlLinkInfo_GetHref(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxHtmlLinkInfo_GetTarget(wxobj), true);
    }
    ...
    {
        return cast(HtmlCell)FindObject(wxHtmlLinkInfo_GetHtmlCell(wxobj), &HtmlCell.New);
    }
    public void htmlCell(HtmlCell value)
    {
        wxHtmlLinkInfo_SetHtmlCell(wxobj, wxObject.SafePtr(value));
    }
}
...
//FIXME            return FindObject(wxHtmlWinParser_GetProduct(wxobj), typeof(wxObject));
    ...
    public DC GetDC()
    {
        return cast(DC)FindObject(wxHtmlWinParser_GetDC(wxobj), &DC.New);
    }
    ...
    {
        return cast(HtmlWindow)FindObject(wxHtmlWinParser_GetWindow(wxobj), &HtmlWindow.New);
    }
    ...
    {
        return cast(HtmlContainerCell)FindObject(wxHtmlWinParser_GetContainer(wxobj), &HtmlContainerCell.New);
    }
    ...
    {
        wxHtmlWinParser_SetFontSize(wxobj, value);
    }
    ...
    {
        wxHtmlWinParser_SetFontBold(wxobj, value);
    }
    ...
    {
        wxHtmlWinParser_SetFontItalic(wxobj, value);
    }
    ...
    {
        wxHtmlWinParser_SetFontUnderlined(wxobj, value);
    }
    ...
    {
        wxHtmlWinParser_SetFontFixed(wxobj, value);
    }

    public string FontFace()
    {
        return cast(string) new wxString(wxHtmlWinParser_GetFontFace(wxobj), true);
    }
    public void FontFace(string value)
    {
        wxHtmlWinParser_SetFontFace(wxobj, value);
    }
    ...
    {
        wxHtmlWinParser_SetAlign(wxobj, value);
    }
    ...
    {
        return new Colour(wxHtmlWinParser_GetLinkColor(wxobj), true);
    }
    public void LinkColor(Colour value)
    {
        wxHtmlWinParser_SetLinkColor(wxobj, wxObject.SafePtr(value));
    }

    public Colour ActualColor()
    {
        return new Colour(wxHtmlWinParser_GetActualColor(wxobj), true);
    }
    public void ActualColor(Colour value)
    {
        wxHtmlWinParser_SetActualColor(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(HtmlLinkInfo)FindObject(wxHtmlWinParser_GetLink(wxobj), &HtmlLinkInfo.New);
    }
    public void Link(HtmlLinkInfo value)
    {
        wxHtmlWinParser_SetLink(wxobj, wxObject.SafePtr(value));
    }
...
public abstract class HtmlTagHandler : wxObject
{
    ...
    {
        wxHtmlTagHandler_SetParser(wxobj, wxObject.SafePtr(value));
    }
...
public class HtmlEntitiesParser : wxObject
{
    ...
    {
        wxHtmlEntitiesParser_SetEncoding(wxobj, cast(int)value);
    }
...
public abstract class HtmlParser : wxObject
{
    ...
    {
        return cast(string) new wxString(wxHtmlParser_GetSource(wxobj), true);
    }
    public void Source(string value)
    {
        wxHtmlParser_SetSource(wxobj, value);
    }

    public void SourceAndSaveState(string value)
    {
        wxHtmlParser_SetSourceAndSaveState(wxobj, value);
    }
...
public abstract class HtmlProcessor : wxObject
{
    ...
    {
        wxHtmlProcessor_Enable(wxobj, value);
    }
    public bool Enabled()
    {
...
public class HtmlRenderingInfo : wxObject
{
    ...
    {
        return cast(HtmlSelection)FindObject(wxHtmlRenderingInfo_GetSelection(wxobj), &HtmlSelection.New);
    }
    public void Selection(HtmlSelection value)
    {
        wxHtmlRenderingInfo_SetSelection(wxobj, wxObject.SafePtr(value));
    }
}
...
public class HtmlSelection : wxObject
{
    ...
    {
        return cast(HtmlCell)FindObject(wxHtmlSelection_GetFromCell(wxobj), &HtmlCell.New);
    }

    public HtmlCell ToCell()
    {
        return cast(HtmlCell)FindObject(wxHtmlSelection_GetToCell(wxobj), &HtmlCell.New);
    }
    ...
    {
        wxHtmlSelection_SetFromPrivPos(wxobj, value);
    }
    ...
    {
        wxHtmlSelection_SetToPrivPos(wxobj, value);
    }
...
public class HtmlEasyPrinting : wxObject
{
    ...
    {
        return cast(PrintData)FindObject(wxHtmlEasyPrinting_GetPrintData(wxobj), &PrintData.New);
    }
    ...
    {
        return cast(PageSetupDialogData)FindObject(wxHtmlEasyPrinting_GetPageSetupData(wxobj), &PageSetupDialogData.New);
    }
}
...
public class HtmlWindow : ScrolledWindow
{
    ...
    {
        return cast(string) new wxString(wxHtmlWindow_GetOpenedPage(wxobj), true);
    }

    public string OpenedAnchor()
    {
        return cast(string) new wxString(wxHtmlWindow_GetOpenedAnchor(wxobj), true);
    }

    public string OpenedPageTitle()
    {
        return cast(string) new wxString(wxHtmlWindow_GetOpenedPageTitle(wxobj), true);
    }
    ...
    {
        return cast(Frame)FindObject(wxHtmlWindow_GetRelatedFrame(wxobj), &Frame.New);
    }
    ...
    {
        wxHtmlWindow_SetRelatedStatusBar(wxobj, value);
    }
    ...
    {
        wxHtmlWindow_SetBorders(wxobj, value);
    }
    ...
    {
        return cast(HtmlContainerCell)FindObject(wxHtmlWindow_GetInternalRepresentation(wxobj), &HtmlContainerCell.New);
    }
    ...
    {
        return cast(HtmlWinParser)FindObject(wxHtmlWindow_GetParser(wxobj), &HtmlWinParser.New);
    }
    ...
    public string Text()
    {
        return cast(string) new wxString(wxHtmlWindow_ToText(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxHtmlWindow_SelectionToText(wxobj), true);
    }
}
