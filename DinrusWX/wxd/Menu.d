...
public class MenuBase : EvtHandler
{
    ...
    public string Title()
    {
        return cast(string) new wxString(wxMenuBase_GetTitle(wxobj), true);
    }
    public void Title(string value)
    {
        wxMenuBase_SetTitle(wxobj, value);
    }
    ...
    {
        wxMenuBase_SetEventHandler(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(Window)FindObject(wxMenuBase_GetInvokingWindow(wxobj), &Window.New);
    }
    public void InvokingWindow(Window value)
    {
        wxMenuBase_SetInvokingWindow(wxobj, wxObject.SafePtr(value));
    }
    ...
    public int Style()
    {
        return cast(int)wxMenuBase_GetStyle(wxobj);
    }
    ...
    {
        return cast(MenuBar)FindObject(wxMenuBase_GetMenuBar(wxobj), &MenuBar.New);
    }
    ...
    public Menu Parent()
    {
        return cast(Menu)FindObject(wxMenuBase_GetParent(wxobj), &Menu.New);
    }
    public void Parent(Menu value)
    {
        wxMenuBase_SetParent(wxobj, wxObject.SafePtr(value));
    }
