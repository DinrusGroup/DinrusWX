...
//
// $Id: Dialog.d,v 1.11 2007/04/19 19:45:26 afb Exp $
//-----------------------------------------------------------------------------
...
public class Dialog : Window
{
    ...
    {
        wxDialog_SetReturnCode(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxDialog_GetTitle(wxobj), true);
    }
    public override void Title(string value)
    {
        wxDialog_SetTitle(wxobj, value);
    }
