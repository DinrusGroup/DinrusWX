...
//
// $Id: TreeCtrl.d,v 1.13 2008/09/26 09:40:42 afb Exp $
//-----------------------------------------------------------------------------
...
public class TreeItemData : ClientData
{
    ...
    {
        return new TreeItemId(wxTreeItemData_GetId(wxobj), true);
    }
    public void Id(TreeItemId value)
    {
        wxTreeItemData_SetId(wxobj, wxObject.SafePtr(value));
    }
}
...
public class TreeItemAttr : wxObject
{
    ...
    {
        return new Colour(wxTreeItemAttr_GetTextColour(wxobj), true);
    }
    public void TextColour(Colour value)
    {
        wxTreeItemAttr_SetTextColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return new Colour(wxTreeItemAttr_GetBackgroundColour(wxobj), true);
    }
    public void BackgroundColour(Colour value)
    {
        wxTreeItemAttr_SetBackgroundColour(wxobj, wxObject.SafePtr(value));
    }
    ...
    public Font font()
    {
        return new Font(wxTreeItemAttr_GetFont(wxobj), true);
    }
    public void font(Font value)
    {
        wxTreeItemAttr_SetFont(wxobj, wxObject.SafePtr(value));
    }
...
public class TreeCtrl : Control
{
    ...
    {
        return cast(ImageList)FindObject(wxTreeCtrl_GetImageList(wxobj), &ImageList.New);
    }

    public void imageList(ImageList value)
    {
        wxTreeCtrl_SetImageList(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(ImageList)FindObject(wxTreeCtrl_GetStateImageList(wxobj), &ImageList.New);
    }

    public void StateImageList(ImageList value)
    {
        wxTreeCtrl_SetStateImageList(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return new TreeItemId(wxTreeCtrl_GetSelection(wxobj), true);
    }
    ...
    {
        return new TreeItemId(wxTreeCtrl_GetRootItem(wxobj), true);
    }
    ...
    {
        wxTreeCtrl_SetIndent(wxobj, value);
    }
    ...
    {
        wxTreeCtrl_SetSpacing(wxobj, value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_BEGIN_DRAG, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_BEGIN_RDRAG, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_BEGIN_LABEL_EDIT, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_END_LABEL_EDIT, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_DELETE_ITEM, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_GET_INFO, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_SET_INFO, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_EXPANDED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_EXPANDING, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_COLLAPSED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_COLLAPSING, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_SEL_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_SEL_CHANGING, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_KEY_DOWN, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_ACTIVATED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_RIGHT_CLICK, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_ITEM_MIDDLE_CLICK, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TREE_END_DRAG, ID, value, this);
    }
...
public class TreeEvent : Event
{
    ...
    {
        return new TreeItemId(wxTreeEvent_GetItem(wxobj), true);
    }
    public void Item(TreeItemId value)
    {
        wxTreeEvent_SetItem(wxobj, wxObject.SafePtr(value));
    }

    public TreeItemId OldItem()
    {
        return new TreeItemId(wxTreeEvent_GetOldItem(wxobj), true);
    }
    public void OldItem(TreeItemId value)
    {
        wxTreeEvent_SetOldItem(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxTreeEvent_SetPoint(wxobj, value);
    }
    ...
    {
        return cast(KeyEvent)FindObject(wxTreeEvent_GetKeyEvent(wxobj), cast(wxObject function(IntPtr ptr))&KeyEvent.New);
    }
    public void keyEvent(KeyEvent value)
    {
        wxTreeEvent_SetKeyEvent(wxobj, wxObject.SafePtr(value));
    }
    ...
    public string Label()
    {
        return cast(string) new wxString(wxTreeEvent_GetLabel(wxobj), true);
    }
    public void Label(string value)
    {
        wxTreeEvent_SetLabel(wxobj, value);
    }
    ...
    {
        wxTreeEvent_SetEditCanceled(wxobj, value);
    }

    public void ToolTip(string value)
    {
        wxTreeEvent_SetToolTip(wxobj, value);
    }
