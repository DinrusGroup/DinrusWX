...
public class SplashScreen : Frame
{
    ...
    {
        return cast(SplashScreenWindow)FindObject(wxSplashScreen_GetSplashWindow(wxobj), &SplashScreenWindow.New);
    }
...
public class SplashScreenWindow : Window
{
    ...
    {
        wxSplashScreenWindow_SetBitmap(wxobj, wxObject.SafePtr(value));
    }
    public Bitmap bitmap()
    {
        return cast(Bitmap)FindObject(wxSplashScreenWindow_GetBitmap(wxobj));
    }
}
