...
public class MenuItem : wxObject
{
    ...
    */	//-----------------------------------------------------------------------------
    ...
    public Menu menu()
    {
        return cast(Menu)FindObject(wxMenuItem_GetMenu(wxobj), &Menu.New);
    }
    public void menu(Menu value)
    {
        wxMenuItem_SetMenu(wxobj, wxObject.SafePtr(value));
    }
    ...
    public int ID()
    {
        return wxMenuItem_GetId(wxobj);
    }
    public void ID(int value)
    {
        wxMenuItem_SetId(wxobj, value);
    }
    ...
    {
        return wxMenuItem_IsSeparator(wxobj);
    }
    ...
    {
        wxMenuItem_SetText(wxobj, value);
    }
    public string Text()
    {
        return cast(string) new wxString(wxMenuItem_GetText(wxobj), true);
    }
    ...
    public string Label()
    {
        return cast(string) new wxString(wxMenuItem_GetLabel(wxobj), true);
    }
    ...
    {
        return cast(ItemKind)wxMenuItem_GetKind(wxobj);
    }
    ...
    {
        wxMenuItem_SetCheckable(wxobj, value);
    }
    public bool Checkable()
    {
        return wxMenuItem_IsCheckable(wxobj);
    }
    ...
    {
        return wxMenuItem_IsSubMenu(wxobj);
    }

    public void SubMenu(Menu value)
    {
        wxMenuItem_SetSubMenu(wxobj, wxObject.SafePtr(value));
    }
    public Menu SubMenu()
    {
        return cast(Menu)FindObject(wxMenuItem_GetSubMenu(wxobj), &Menu.New);
    }
    ...
    {
        wxMenuItem_Enable(wxobj, value);
    }
    public bool Enabled()
    {
        return wxMenuItem_IsEnabled(wxobj);
    }
    ...
    {
        wxMenuItem_Check(wxobj, value);
    }
    public bool Checked()
    {
        return wxMenuItem_IsChecked(wxobj);
    }
    ...
    {
        wxMenuItem_SetHelp(wxobj, value);
    }
    public string Help()
    {
        return cast(string) new wxString(wxMenuItem_GetHelp(wxobj), true);
    }
    ...
    {
        return cast(AcceleratorEntry)FindObject(wxMenuItem_GetAccel(wxobj), &AcceleratorEntry.New);
    }
    public void Accel(AcceleratorEntry value)
    {
        wxMenuItem_SetAccel(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxMenuItem_SetName(wxobj, value);
    }
    public string Name()
    {
        return cast(string) new wxString(wxMenuItem_GetName(wxobj), true);
    }
    ...
    {
        wxMenuItem_SetBitmap(wxobj, wxObject.SafePtr(value));
    }
    public Bitmap bitmap()
    {
        return cast(Bitmap)FindObject(wxMenuItem_GetBitmap(wxobj), &Bitmap.New);
    }
    +/
    //---------------------------------------------------------------------
    ...
    {
        this.menu.AddEvent(ID, value, this);
    }
