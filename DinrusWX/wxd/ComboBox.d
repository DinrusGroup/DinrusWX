...
public class ComboBox : Control
{
    ...
    {
        wxComboBox_SetSelectionSingle(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxComboBox_GetStringSelection(wxobj), true);
    }
    public void StringSelection(string value)
    {
        wxComboBox_SetStringSelection(wxobj, value);
    }
    ...
    {
        wxComboBox_SetInsertionPoint(wxobj, cast(uint)value);
    }
    ...
    {
        wxComboBox_SetEditable(wxobj, value);
    }
    ...
    public string Value()
    {
        return cast(string) new wxString(wxComboBox_GetValue(wxobj), true);
    }
    public void Value(string value)
    {
        wxComboBox_SetValue(wxobj, value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_COMBOBOX_SELECTED, ID, value, this);
    }
