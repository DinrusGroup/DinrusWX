...
public class CalendarCtrl : Control
{
    ...
    public this(Window parent, int id, wxDateTime date = null /*wxDefaultDateTime*/, Point pos = wxDefaultPosition, Size size =wxDefaultSize, int style = wxCAL_SHOW_HOLIDAYS | wxWANTS_CHARS, string name = wxCalendarNameStr)
    {
        ...
        {
            throw new InvalidOperationException("Не удалось создать CalendarCtrl");
        }
    }
    ...
    {
        wxCalendarCtrl_SetDate(wxobj, wxObject.SafePtr(cast(wxDateTime)value));
    }
    ...
    {
        wxCalendarCtrl_SetLowerDateLimit(wxobj, wxObject.SafePtr(cast(wxDateTime)value));
    }
    ...
    {
        wxCalendarCtrl_SetUpperDateLimit(wxobj, wxObject.SafePtr(cast(wxDateTime)value));
    }
    ...
    {
        wxCalendarCtrl_EnableYearChange(wxobj, value);
    }

    public void EnableMonthChange(bool value)
    {
        wxCalendarCtrl_EnableMonthChange(wxobj, value);
    }

    public void EnableHolidayDisplay(bool value)
    {
        wxCalendarCtrl_EnableHolidayDisplay(wxobj, value);
    }
    ...
    {
        return new Colour(wxCalendarCtrl_GetHeaderColourFg(wxobj), true);
    }

    public Colour HeaderColourBg()
    {
        return new Colour(wxCalendarCtrl_GetHeaderColourBg(wxobj), true);
    }
    ...
    {
        return new Colour(wxCalendarCtrl_GetHighlightColourFg(wxobj));
    }

    public Colour HighlightColourBg()
    {
        return new Colour(wxCalendarCtrl_GetHighlightColourBg(wxobj));
    }
    ...
    {
        return new Colour(wxCalendarCtrl_GetHolidayColourFg(wxobj));
    }

    public Colour HolidayColourBg()
    {
        return new Colour(wxCalendarCtrl_GetHolidayColourBg(wxobj));
    }
    ...
    {
        AddCommandListener(Event.wxEVT_CALENDAR_SEL_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_CALENDAR_DAY_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_CALENDAR_MONTH_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_CALENDAR_YEAR_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_CALENDAR_DOUBLECLICKED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_CALENDAR_WEEKDAY_CLICKED, ID, value, this);
    }
...
public class CalendarDateAttr : wxObject
{
    ...
    {
        wxCalendarDateAttr_SetTextColour(wxobj, wxObject.SafePtr(value));
    }
    public Colour TextColour()
    {
        return new Colour(wxCalendarDateAttr_GetTextColour(wxobj));
    }
    ...
    {
        wxCalendarDateAttr_SetBackgroundColour(wxobj, wxObject.SafePtr(value));
    }
    public Colour BackgroundColour()
    {
        return new Colour(wxCalendarDateAttr_GetBackgroundColour(wxobj));
    }
    ...
    {
        wxCalendarDateAttr_SetBorderColour(wxobj, wxObject.SafePtr(value));
    }
    public Colour BorderColour()
    {
        return new Colour(wxCalendarDateAttr_GetBorderColour(wxobj));
    }
    ...
    {
        wxCalendarDateAttr_SetFont(wxobj, wxObject.SafePtr(value));
    }
    public Font font()
    {
        return new Font(wxCalendarDateAttr_GetFont(wxobj));
    }
    ...
    {
        wxCalendarDateAttr_SetBorder(wxobj, cast(int)value);
    }
    public CalendarDateBorder Border()
    {
        return cast(CalendarDateBorder)wxCalendarDateAttr_GetBorder(wxobj);
    }
    ...
    {
        wxCalendarDateAttr_SetHoliday(wxobj, value);
    }
    ...
    {
        return new CalendarDateAttr(ptr);
    }
    //-----------------------------------------------------------------------------
}
...
public class CalendarEvent : CommandEvent
{
    ...
    {
        return cast(DayOfWeek)wxCalendarEvent_GetWeekDay(wxobj);
    }
