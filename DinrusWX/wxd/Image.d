...
public class Image : wxObject
{
    ...
    {
        SetMaskColour(value.Red, value.Green, value.Blue);
    }
    ...
    {
        return cast(Palette)FindObject(wxImage_GetPalette(wxobj), &Palette.New);
    }
    public void palette(Palette value)
    {
        wxImage_SetPalette(wxobj, wxObject.SafePtr(value));
    }
    ...
    */
    ...
    {
        return cast(string) new wxString(wxImage_GetImageExtWildcard(), true);
    }
...
public class ImageHandler : wxObject
{
    ...
    public string Name()
    {
        return cast(string) new wxString(wxImageHandler_GetName(wxobj), true);
    }
    public void Name(string value)
    {
        wxImageHandler_SetName(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxImageHandler_GetExtension(wxobj), true);
    }
    public void Extension(string value)
    {
        wxImageHandler_SetExtension(wxobj, value);
    }
    ...
    public int Type()
    {
        return cast(int)wxImageHandler_GetType(wxobj);
    }
    public void Type(int value)
    {
        wxImageHandler_SetType(wxobj, cast(uint)value);
    }
    ...
    {
        return cast(string) new wxString(wxImageHandler_GetMimeType(wxobj), true);
    }
    public void MimeType(string value)
    {
        wxImageHandler_SetMimeType(wxobj, value);
    }
}
...
public class ImageHistogramEntry : wxObject
{
    ...
    {
        wxImageHistogramEntry_Setindex(wxobj, value);
    }
    ...
    {
        wxImageHistogramEntry_Setvalue(wxobj, value);
    }
}
