...
public class PrintPreview : wxObject
{
    ...
    {
        wxPrintPreview_SetPrintout(wxobj, wxObject.SafePtr(value));
    }
    public Printout printout()
    {
        return cast(Printout)FindObject(wxPrintPreview_GetPrintout(wxobj)/*, &Printout.New*/);
    }
    ...
    {
        return cast(Printout)FindObject(wxPrintPreview_GetPrintoutForPrinting(wxobj)/*, &Printout.New*/);
    }
    ...
    {
        wxPrintPreview_SetFrame(wxobj, wxObject.SafePtr(value));
    }
    public Frame frame()
    {
        return cast(Frame)FindObject(wxPrintPreview_GetFrame(wxobj), &Frame.New);
    }
    ...
    {
        return cast(Window)FindObject(wxPrintPreview_GetCanvas(wxobj), &Window.New);
    }
    public void Canvas(Window value)
    {
        wxPrintPreview_SetCanvas(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(PrintDialogData)FindObject(wxPrintPreview_GetPrintDialogData(wxobj), &PrintDialogData.New);
    }
    ...
    {
        wxPrintPreview_SetZoom(wxobj, value);
    }
    public int Zoom()
    {
    ...
    {
        wxPrintPreview_SetOk(wxobj, value);
    }
...
public class PreviewControlBar : Panel
{
    ...
    {
        wxPreviewControlBar_SetZoomControl(wxobj, value);
    }
    ...
    {
        return cast(PrintPreview)FindObject(wxPreviewControlBar_GetPrintPreview(wxobj), &PrintPreview.New);
    }
}
