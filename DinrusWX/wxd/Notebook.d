...
public class NotebookEvent : Event
{
    ...
    {
        wxNotebookEvent_SetSelection(wxobj, value);
    }
    ...
    {
        wxNotebookEvent_SetOldSelection(wxobj, value);
    }
...
public class Notebook : Control
{
    ...
    {
        wxNotebook_SetImageList(wxobj, wxObject.SafePtr(value));
    }
    public ImageList Images()
    {
        return cast(ImageList)FindObject(wxNotebook_GetImageList(wxobj));
    }
    ...
    public void Selection(int value)
    {
        wxNotebook_SetSelection(wxobj, value);
    }
    ...
    {
        wxNotebook_SetPageSize(wxobj, value);
    }

    public void Padding(Size value)
    {
        wxNotebook_SetPadding(wxobj, value);
    }

    public void TabSize(Size value)
    {
        wxNotebook_SetTabSize(wxobj, value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGING, ID, value, this);
    }
