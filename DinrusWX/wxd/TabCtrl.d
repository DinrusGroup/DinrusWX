...
//! \endcond
    ...
    public class TabEvent : Event
    {
        ...
        {
            wxTabEvent_SetSelection(wxobj, value);
        }
        ...
        {
            wxTabEvent_SetOldSelection(wxobj, value);
        }
    ...
    public class TabCtrl : Control
    {
        ...
        public void Selection(int value)
        {
            wxTabCtrl_SetSelection(wxobj, value);
        }
        ...
        {
            return cast(wxImageList)FindObject(wxTabCtrl_GetImageList(wxobj));
        }
        public void ImageList(wxImageList value)
        {
            wxTabCtrl_SetImageList(wxobj, wxObject.SafePtr(value));
        }
        ...
        {
            wxTabCtrl_SetItemSize(wxobj, value);
        }
        ...
        {
            wxTabCtrl_SetPadding(wxobj, value);
        }
        ...
        {
            AddCommandListener(Event.wxEVT_COMMAND_TAB_SEL_CHANGED, ID, value, this);
        }
        ...
        {
            AddCommandListener(Event.wxEVT_COMMAND_TAB_SEL_CHANGING, ID, value, this);
        }
