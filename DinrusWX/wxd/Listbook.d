...
public class ListbookEvent : Event
{
    ...
    {
        wxListbookEvent_SetSelection(wxobj, value);
    }
    ...
    {
        wxListbookEvent_SetOldSelection(wxobj, value);
    }
...
public class Listbook : Control
{
    ...
    public void Selection(int value)
    {
        wxListbook_SetSelection(wxobj, value);
    }
    ...
    {
        wxListbook_SetImageList(wxobj, wxObject.SafePtr(value));
    }
    public ImageList imageList()
    {
        return cast(ImageList)FindObject(wxListbook_GetImageList(wxobj), &ImageList.New);
    }
    ...
    {
        wxListbook_SetPageSize(wxobj, value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LISTBOOK_PAGE_CHANGED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LISTBOOK_PAGE_CHANGING, ID, value, this);
    }
