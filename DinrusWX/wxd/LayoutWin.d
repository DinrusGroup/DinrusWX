...
public class SashLayoutWindow : SashWindow
{
    ...
    {
        wxSashLayoutWindow_SetAlignment(wxobj, value);
    }
    ...
    {
        wxSashLayoutWindow_SetOrientation(wxobj, value);
    }
    ...
    {
        wxSashLayoutWindow_SetDefaultSize(wxobj, value);
    }
}
...
public class QueryLayoutInfoEvent : Event
{
    ...
    {
        wxQueryLayoutInfoEvent_SetRequestedLength(wxobj, value);
    }
    ...
    {
        wxQueryLayoutInfoEvent_SetFlags(wxobj, value);
    }
    ...
    {
        wxQueryLayoutInfoEvent_SetSize(wxobj, value);
    }
    ...
    public void Orientation(LayoutOrientation value)
    {
        wxQueryLayoutInfoEvent_SetOrientation(wxobj, value);
    }
    ...
    public void Alignment(LayoutAlignment value)
    {
        wxQueryLayoutInfoEvent_SetAlignment(wxobj, value);
    }

    private static Event New(IntPtr obj)
    {
        return new QueryLayoutInfoEvent(obj);
    }
...
public class CalculateLayoutEvent : Event
{
    ...
    public void Flags(int value)
    {
        wxCalculateLayoutEvent_SetFlags(wxobj, value);
    }
    ...
    {
        wxCalculateLayoutEvent_SetRect(wxobj, value);
    }

    private static Event New(IntPtr obj)
    {
        return new CalculateLayoutEvent(obj);
    }
