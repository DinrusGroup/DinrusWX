...
public class FileDialog : Dialog
{
    ...
    {
        return cast(string) new wxString(wxFileDialog_GetDirectory(wxobj), true);
    }
    public void Directory(string value)
    {
        wxFileDialog_SetDirectory(wxobj, value);
    }

    public string Filename()
    {
        return cast(string) new wxString(wxFileDialog_GetFilename(wxobj), true);
    }
    public void Filename(string value)
    {
        wxFileDialog_SetFilename(wxobj, value);
    }

    public string Path()
    {
        return cast(string) new wxString(wxFileDialog_GetPath(wxobj), true);
    }
    public void Path(string value)
    {
        wxFileDialog_SetPath(wxobj, value);
    }

    public void FilterIndex(int value)
    {
        wxFileDialog_SetFilterIndex(wxobj,value);
    }
    ...
    {
        wxFileDialog_SetMessage(wxobj,value);
    }
    public string Message()
    {
        return cast(string) new wxString(wxFileDialog_GetMessage(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxFileDialog_GetWildcard(wxobj), true);
    }
    public void Wildcard(string value)
    {
        wxFileDialog_SetWildcard(wxobj, value);
    }

    public int Style()
    {
        return cast(int)wxFileDialog_GetStyle(wxobj);
    }
    public void Style(int value)
    {
        wxFileDialog_SetStyle(wxobj, cast(int)value);
    }
    ...
    public string[] Paths()
    {
        return (new ArrayString(wxFileDialog_GetPaths(wxobj), true)).toArray();
    }

    public string[] Filenames()
    {
        return (new ArrayString(wxFileDialog_GetFilenames(wxobj), true)).toArray();
    }
}
