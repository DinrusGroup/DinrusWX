...
// $Id: GridBagSizer.d,v 1.10 2009/01/16 14:06:00 afb Exp $
//-----------------------------------------------------------------------------
...
public class GBSizerItem : SizerItem
{
    ...
    {
        return cast(GBPosition)FindObject(wxGBSizerItem_GetPos(wxobj), &GBPosition.New);
    }
    public void Pos(GBPosition value)
    {
        wxGBSizerItem_SetPos(wxobj, wxObject.SafePtr(value));
    }
    ...
    public GBSpan Span()
    {
        return cast(GBSpan)FindObject(wxGBSizerItem_GetSpan(wxobj), &GBSpan.New);
    }
    public void Span(GBSpan value)
    {
        wxGBSizerItem_SetSpan(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(GridBagSizer)FindObject(wxGBSizerItem_GetGBSizer(wxobj), &GridBagSizer.New);
    }
    public void GBSizer(GridBagSizer value)
    {
        wxGBSizerItem_SetGBSizer(wxobj, wxObject.SafePtr(value));
    }
...
public class GBSpan : wxObject
{
    ...
    {
        wxGBSpan_SetRowspan(wxobj, value);
    }
    ...
    {
        wxGBSpan_SetColspan(wxobj, value);
    }
}
...
public class GridBagSizer : FlexGridSizer
{
    ...
    {
        wxGridBagSizer_SetEmptyCellSize(wxobj, value);
    }
