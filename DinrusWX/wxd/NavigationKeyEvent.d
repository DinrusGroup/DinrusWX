...
public class NavigationKeyEvent : Event
{
    ...
    {
        wxNavigationKeyEvent_SetDirection(wxobj, value);
    }
    ...
    {
        wxNavigationKeyEvent_SetWindowChange(wxobj, value);
    }
    ...
    {
        return cast(Window)FindObject(wxNavigationKeyEvent_GetCurrentFocus(wxobj), &Window.New);
    }
    public void CurrentFocus(Window value)
    {
        wxNavigationKeyEvent_SetCurrentFocus(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxNavigationKeyEvent_SetFlags(wxobj, cast(uint)value);
    }

    private static Event New(IntPtr obj)
    {
        return new NavigationKeyEvent(obj);
    }
