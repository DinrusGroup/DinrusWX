...
public class RadioBox : Control
{
    ...
    {
        wxRadioBox_SetSelection(wxobj, value);
    }
    ...
    {
        wxRadioBox_SetStringSelection(wxobj, value);
    }
    public string StringSelection()
    {
        return cast(string) new wxString(wxRadioBox_GetStringSelection(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxRadioBox_GetLabel(wxobj), true);
    }
    public override void Label(string value)
    {
        wxRadioBox_SetLabel(wxobj, value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_RADIOBOX_SELECTED, ID, value, this);
    }
