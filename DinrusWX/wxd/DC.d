...
public class DC : wxObject
{
    ...
    {
        wxDC_SetBackgroundMode(wxobj, value);
    }
    public FillStyle BackgroundMode()
    {
        return cast(FillStyle)wxDC_GetBackgroundMode(wxobj);
    }
    ...
    {
        wxDC_SetBrush(wxobj, wxObject.SafePtr(value));
    }
    public Brush brush()
    {
        return new Brush(wxDC_GetBrush(wxobj));
    }

    public void Background(Brush value)
    {
        wxDC_SetBackground(wxobj, wxObject.SafePtr(value));
    }
    public Brush Background()
    {
        return new Brush(wxDC_GetBackground(wxobj));
    }
    ...
    {
        wxDC_SetPen(wxobj, value.wxobj);
    }
    public Pen pen()
    {
        return cast(Pen)FindObject(wxDC_GetPen(wxobj), &Pen.New);
    }
    ...
    {
        return cast(Colour)FindObject(wxDC_GetTextForeground(wxobj), &Colour.New);
    }
    public void TextForeground(Colour value)
    {
        wxDC_SetTextForeground(wxobj, wxObject.SafePtr(value));
    }

    public Colour TextBackground()
    {
        return cast(Colour)FindObject(wxDC_GetTextBackground(wxobj), &Colour.New);
    }
    public void TextBackground(Colour value)
    {
        wxDC_SetTextBackground(wxobj, wxObject.SafePtr(value));
    }
    ...
    public Font font()
    {
        return cast(Font)FindObject(wxDC_GetFont(wxobj), &Font.New);
    }
    public void font(Font value)
    {
        wxDC_SetFont(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxDC_SetLogicalFunction(wxobj, cast(int)value);
    }
