...
public class CommandEvent : Event
{
    ...
    {
        return cast(string) new wxString(wxCommandEvent_GetString(wxobj), true);
    }
    public void String(string value)
    {
        wxCommandEvent_SetString(wxobj, value);
    }
    ...
    {
        wxCommandEvent_SetInt(wxobj, value);
    }
    ...
    {
        return cast(ClientData)FindObject(wxCommandEvent_GetClientObject(wxobj));
    }
    public void ClientObject(ClientData value)
    {
        wxCommandEvent_SetClientObject(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(int)wxCommandEvent_GetExtraLong(wxobj);
    }
    public void ExtraLong(int value)
    {
        wxCommandEvent_SetExtraLong(wxobj, cast(uint)value);
    }

    private static Event New(IntPtr obj)
    {
        return new CommandEvent(obj);
    }
