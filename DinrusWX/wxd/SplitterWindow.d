...
public class SplitterWindow : Window
{
    ...
    {
        wxSplitWnd_SetSplitMode(wxobj, cast(int)value);
    }
    ...
    {
        wxSplitWnd_SetMinimumPaneSize(wxobj, value);
    }
    ...
    {
        return cast(Window)FindObject(wxSplitWnd_GetWindow1(wxobj), &myNew);
    }
    ...
    {
        return cast(Window)FindObject(wxSplitWnd_GetWindow2(wxobj), &myNew);
    }
