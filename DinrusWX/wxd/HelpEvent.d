...
public class HelpEvent : CommandEvent
{
    ...
    {
        wxHelpEvent_SetPosition(wxobj, value);
    }
    ...
    public string Link()
    {
        return cast(string) new wxString(wxHelpEvent_GetLink(wxobj), true);
    }
    public void Link(string value)
    {
        wxHelpEvent_SetLink(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxHelpEvent_GetTarget(wxobj), true);
    }
    public void Target(string value)
    {
        wxHelpEvent_SetTarget(wxobj, value);
    }


    private static Event New(IntPtr obj)
    {
        return new HelpEvent(obj);
    }
