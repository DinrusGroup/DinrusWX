...
public class ListBox : Control
{
    ...
    {
        return cast(string) new wxString(wxListBox_GetStringSelection(wxobj), true);
    }
    public void StringSelection(string value)
    {
        wxListBox_SetStringSelection(wxobj, value, true);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LISTBOX_SELECTED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, ID, value, this);
    }
...
public class CheckListBox : ListBox
{
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_CHECKLISTBOX_TOGGLED, ID, value, this);
    }
