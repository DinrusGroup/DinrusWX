...
//
// $Id: PrintData.d,v 1.10 2007/01/28 23:06:37 afb Exp $
//-----------------------------------------------------------------------------
...
public class PageSetupDialogData : wxObject
{
    ...
    {
        return new PageSetupDialogData(ptr);
    }
    //-----------------------------------------------------------------------------
    ...
    {
        wxPageSetupDialogData_SetPaperSize(wxobj, value);
    }

    public PaperSize PaperId()
    {
        return cast(PaperSize)wxPageSetupDialogData_GetPaperId(wxobj);
    }
    public void PaperId(PaperSize value)
    {
        wxPageSetupDialogData_SetPaperId(wxobj, cast(int)value);
    }
    ...
    {
        wxPageSetupDialogData_SetMinMarginTopLeft(wxobj, value);
    }
    ...
    {
        wxPageSetupDialogData_SetMinMarginBottomRight(wxobj, value);
    }
    ...
    {
        wxPageSetupDialogData_SetMarginTopLeft(wxobj, value);
    }
    ...
    {
        wxPageSetupDialogData_SetMarginBottomRight(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetDefaultMinMargins(wxobj);
    }
    public void DefaultMinMargins(bool value)
    {
        wxPageSetupDialogData_SetDefaultMinMargins(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetEnableOrientation(wxobj);
    }
    public void EnableOrientation(bool value)
    {
        wxPageSetupDialogData_EnableOrientation(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetEnablePaper(wxobj);
    }
    public void EnablePaper(bool value)
    {
        wxPageSetupDialogData_EnablePaper(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetEnablePrinter(wxobj);
    }
    public void EnablePrinter(bool value)
    {
        wxPageSetupDialogData_EnablePrinter(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetDefaultInfo(wxobj);
    }
    public void DefaultInfo(bool value)
    {
        wxPageSetupDialogData_SetDefaultInfo(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetEnableHelp(wxobj);
    }
    public void EnableHelp(bool value)
    {
        wxPageSetupDialogData_EnableHelp(wxobj, value);
    }
    ...
    {
        return wxPageSetupDialogData_GetEnableMargins(wxobj);
    }
    public void EnableMargins(bool value)
    {
        wxPageSetupDialogData_EnableMargins(wxobj, value);
    }
    ...
    {
        return cast(PrintData)FindObject(wxPageSetupDialogData_GetPrintData(wxobj), &PrintData.New);
    }
    public void printData(PrintData value)
    {
        wxPageSetupDialogData_SetPrintData(wxobj, wxObject.SafePtr(value));
    }
...
public class PrintDialogData : wxObject
{
    ...
    {
        wxPrintDialogData_SetFromPage(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetToPage(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetMinPage(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetMaxPage(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetNoCopies(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetAllPages(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetSelection(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetCollate(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_SetPrintToFile(wxobj, value);
    }
    ...
    {
        return wxPrintDialogData_GetSetupDialog(wxobj);
    }
    public void SetupDialog(bool value)
    {
        wxPrintDialogData_SetSetupDialog(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_EnablePrintToFile(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_EnableSelection(wxobj, value);
    }
    ...
    {
        wxPrintDialogData_EnablePageNumbers(wxobj, value);
    }
    ...
    public void EnableHelp(bool value)
    {
        wxPrintDialogData_EnableHelp(wxobj, value);
    }
    public bool EnableHelp()
    {
    ...
    public PrintData printData()
    {
        return cast(PrintData)FindObject(wxPrintDialogData_GetPrintData(wxobj), &PrintData.New);
    }
    public void printData(PrintData value)
    {
        wxPrintDialogData_SetPrintData(wxobj, wxObject.SafePtr(value));
    }
}
...
public class PrintData : wxObject
{
    ...
    public void NoCopies(int value)
    {
        wxPrintData_SetNoCopies(wxobj, value);
    }
    ...
    public void Collate(bool value)
    {
        wxPrintData_SetCollate(wxobj, value);
    }
    ...
    {
        wxPrintData_SetOrientation(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxPrintData_GetPrinterName(wxobj), true);
    }
    public void PrinterName(string value)
    {
        wxPrintData_SetPrinterName(wxobj, value);
    }
    ...
    {
        wxPrintData_SetColour(wxobj, value);
    }
    ...
    {
        wxPrintData_SetDuplex(wxobj, cast(int)value);
    }
    ...
    public void PaperId(PaperSize value)
    {
        wxPrintData_SetPaperId(wxobj, cast(int)value);
    }
    ...
    public void paperSize(Size value)
    {
        wxPrintData_SetPaperSize(wxobj, value);
    }
    ...
    {
        wxPrintData_SetQuality(wxobj, cast(int)value);
    }
    ...
    {
        return cast(string) new wxString(wxPrintData_GetPrinterCommand(wxobj), true);
    }
    public void PrinterCommand(string value)
    {
        wxPrintData_SetPrinterCommand(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxPrintData_GetPrinterOptions(wxobj), true);
    }
    public void PrinterOptions(string value)
    {
        wxPrintData_SetPrinterOptions(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxPrintData_GetPreviewCommand(wxobj), true);
    }
    public void PreviewCommand(string value)
    {
        wxPrintData_SetPreviewCommand(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxPrintData_GetFilename(wxobj), true);
    }
    public void Filename(string value)
    {
        wxPrintData_SetFilename(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxPrintData_GetFontMetricPath(wxobj), true);
    }
    public void FontMetricPath(string value)
    {
        wxPrintData_SetFontMetricPath(wxobj, value);
    }
    ...
    {
        wxPrintData_SetPrinterScaleX(wxobj, value);
    }
    ...
    {
        wxPrintData_SetPrinterScaleY(wxobj, value);
    }
    ...
    {
        wxPrintData_SetPrinterTranslateX(wxobj, value);
    }
    ...
    {
        wxPrintData_SetPrinterTranslateY(wxobj, value);
    }
    ...
    {
        wxPrintData_SetPrintMode(wxobj, cast(int)value);
    }
