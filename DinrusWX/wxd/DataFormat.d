...
public class DataFormat : wxObject
{
    ...
    public string Id()
    {
        return cast(string) new wxString(wxDataFormat_GetId(wxobj), true);
    }
    public void Id(string value)
    {
        wxDataFormat_SetId(wxobj, value);
    }
    ...
    {
        return cast(DataFormatId)wxDataFormat_GetType(wxobj);
    }
    public void Type(DataFormatId value)
    {
        wxDataFormat_SetType(wxobj, cast(int)value);
    }
}
