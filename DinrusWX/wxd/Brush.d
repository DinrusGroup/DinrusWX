...
public class Brush : GDIObject
{
    ...
    {
        return cast(Bitmap)FindObject(wxBrush_GetStipple(wxobj), &Bitmap.New);
    }
    public void Stipple(Bitmap value)
    {
        wxBrush_SetStipple(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return new Colour(wxBrush_GetColour(wxobj), true);
    }
    public void colour(Colour value)
    {
        wxBrush_SetColour(wxobj, wxObject.SafePtr(value));
    }
}
