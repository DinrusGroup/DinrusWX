...
public class FindReplaceDialog : Dialog
{
    ...
    {
        return cast(FindReplaceData)FindObject(wxFindReplaceDialog_GetData(wxobj), &FindReplaceData.New);
    }
    public void Data(FindReplaceData value)
    {
        wxFindReplaceDialog_SetData(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_FIND, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_FIND_NEXT, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_FIND_REPLACE, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_FIND_REPLACE_ALL, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_FIND_CLOSE, ID, value, this);
    }
...
public class FindDialogEvent : CommandEvent
{
    ...
    {
        wxFindDialogEvent_SetFlags(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxFindDialogEvent_GetFindString(wxobj), true);
    }
    public void FindString(string value)
    {
        wxFindDialogEvent_SetFindString(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxFindDialogEvent_GetReplaceString(wxobj), true);
    }
    public void ReplaceString(string value)
    {
        wxFindDialogEvent_SetReplaceString(wxobj, value);
    }
    ...
    {
        return cast(FindReplaceDialog)FindObject(wxFindDialogEvent_GetDialog(wxobj));
    }
}
...
public class FindReplaceData : wxObject
{
    ...
    public string FindString()
    {
        return cast(string) new wxString(wxFindReplaceData_GetFindString(wxobj), true);
    }
    public void FindString(string value)
    {
        wxFindReplaceData_SetFindString(wxobj, value);
    }
    ...
    public string ReplaceString()
    {
        return cast(string) new wxString(wxFindReplaceData_GetReplaceString(wxobj), true);
    }
    public void ReplaceString(string value)
    {
        wxFindReplaceData_SetReplaceString(wxobj, value);
    }
    ...
    public void Flags(int value)
    {
        wxFindReplaceData_SetFlags(wxobj, value);
    }
