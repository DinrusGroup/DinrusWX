...
public class SizerItem : wxObject
{
    ...
    {
        wxSizerItem_SetRatioFloat(wxobj, value);
    }
    public float Ratio()
    {
    ...
    {
        wxSizerItem_SetProportion(wxobj, value);
    }
    ...
    {
        wxSizerItem_SetFlag(wxobj, value);
    }
    public int Flag()
    {
    ...
    {
        wxSizerItem_SetBorder(wxobj, value);
    }
    public int Border()
    {
    ...
    {
        return cast(Window)FindObject(wxSizerItem_GetWindow(wxobj));
    }
    public void window(Window value)
    {
        wxSizerItem_SetWindow(wxobj, wxObject.SafePtr(value));
    }
    ...
    public Sizer sizer()
    {
        return cast(Sizer)FindObject(wxSizerItem_GetSizer(wxobj));
    }
    public void sizer(Sizer value)
    {
        wxSizerItem_SetSizer(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxSizerItem_SetSpacer(wxobj, value);
    }
    ...
    {
        return FindObject(wxSizerItem_GetUserData(wxobj));
    }
