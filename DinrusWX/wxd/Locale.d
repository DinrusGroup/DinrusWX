...
public class LanguageInfo : wxObject
{
    ...
    {
        wxLanguageInfo_SetLanguage(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxLanguageInfo_GetCanonicalName(wxobj), true);
    }
    public void CanonicalName(string value)
    {
        wxLanguageInfo_SetCanonicalName(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxLanguageInfo_GetDescription(wxobj), true);
    }
    public void Description(string value)
    {
        wxLanguageInfo_SetDescription(wxobj, value);
    }
}
...
public class Locale : wxObject
{
    ...
    public string CanonicalName()
    {
        return cast(string) new wxString(wxLocale_GetCanonicalName(wxobj), true);
    }
    ...
    public string Name()
    {
        return cast(string) new wxString(wxLocale_GetName(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxLocale_GetSysName(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxLocale_GetSystemEncodingName(), true);
    }
