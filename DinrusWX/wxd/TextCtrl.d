...
public class TextAttr : wxObject
{
    ...
    {
        wxTextAttr_SetTextColour(wxobj, wxObject.SafePtr(value));
    }
    public Colour TextColour()
    {
        return new Colour(wxTextAttr_GetTextColour(wxobj), true);
    }
    ...
    {
        wxTextAttr_SetBackgroundColour(wxobj, wxObject.SafePtr(value));
    }
    public Colour BackgroundColour()
    {
        return new Colour(wxTextAttr_GetBackgroundColour(wxobj), true);
    }
    ...
    {
        wxTextAttr_SetFont(wxobj, wxObject.SafePtr(value));
    }
    public Font font()
    {
        return new Font(wxTextAttr_GetFont(wxobj));
    }
    ...
    {
        wxTextAttr_SetAlignment(wxobj, cast(int)value);
    }
    ...
    {
        wxTextAttr_SetRightIndent(wxobj, value);
    }
    ...
    {
        wxTextAttr_SetFlags(wxobj, cast(uint)value);
    }
    public int Flags()
    {
        return cast(int)wxTextAttr_GetFlags(wxobj);
    }
...
public class TextCtrl : Control
{
    ...
    {
        wxTextCtrl_SetMaxLength(wxobj, cast(uint)value);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TEXT_UPDATED, ID, value, this);
    }
    ...
    {
        AddCommandListener(Event.wxEVT_COMMAND_TEXT_ENTER, ID, value, this);
    }
