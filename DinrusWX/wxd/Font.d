...
public class Font : GDIObject, ICloneable
{
    ...
    {
        return new Font(wxFont_NORMAL_FONT());
    }
    public static Font wxSMALL_FONT()
    {
        return new Font(wxFont_SMALL_FONT());
    }
    public static Font wxITALIC_FONT()
    {
        return new Font(wxFont_ITALIC_FONT());
    }
    public static Font wxSWISS_FONT()
    {
        return new Font(wxFont_SWISS_FONT());
    }
    ...
    {
        wxFont_SetPointSize(wxobj, value);
    }

    public FontFamily Family()
    {
        return cast(FontFamily)wxFont_GetFamily(wxobj);
    }
    public void Family(FontFamily value)
    {
        wxFont_SetFamily(wxobj, cast(int)value);
    }

    public FontStyle Style()
    {
        return cast(FontStyle)wxFont_GetStyle(wxobj);
    }
    public void Style(FontStyle value)
    {
        wxFont_SetStyle(wxobj, cast(int)value);
    }
    ...
    {
        wxFont_SetEncoding(wxobj, cast(int)value);
    }

    public FontWeight Weight()
    {
        return cast(FontWeight)wxFont_GetWeight(wxobj);
    }
    public void Weight(FontWeight value)
    {
        wxFont_SetWeight(wxobj, cast(int)value);
    }
    ...
    {
        wxFont_SetUnderlined(wxobj, value);
    }

    public string FaceName()
    {
        return cast(string) new wxString(wxFont_GetFaceName(wxobj), true);
    }
    public void FaceName(string value)
    {
        wxFont_SetFaceName(wxobj, value);
    }

    public string FamilyString()
    {
        return cast(string) new wxString(wxFont_GetFamilyString(wxobj), true);
    }

    public string StyleString()
    {
        return cast(string) new wxString(wxFont_GetStyleString(wxobj), true);
    }
    ...
    {
        return cast(string) new wxString(wxFont_GetNativeFontInfoUserDesc(wxobj), true);
    }

    public string NativeFontInfoDesc()
    {
        return cast(string) new wxString(wxFont_GetNativeFontInfoDesc(wxobj), true);
    }
