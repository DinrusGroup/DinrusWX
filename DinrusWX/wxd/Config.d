...
public class Config : wxObject
{
    ...
    {
        wxConfigBase_SetPath(wxobj, value);
    }
    public string Path()
    {
        return cast(string) new wxString(wxConfigBase_GetPath(wxobj), true);
    }
    ...
    {
        wxConfigBase_SetExpandEnvVars(wxobj, value);
    }
    ...
    {
        wxConfigBase_SetRecordDefaults(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxConfigBase_GetAppName(wxobj), true);
    }
    public void AppName(string value)
    {
        wxConfigBase_SetAppName(wxobj, value);
    }
    ...
    {
        return cast(string) new wxString(wxConfigBase_GetVendorName(wxobj), true);
    }
    public void VendorName(string value)
    {
        wxConfigBase_SetVendorName(wxobj, value);
    }
    ...
    {
        wxConfigBase_SetStyle(wxobj, value);
    }
    public int Style()
    {
