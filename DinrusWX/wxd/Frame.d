...
public class Frame : Window
{
    ...
    {
        return cast(StatusBar)FindObject(wxFrame_GetStatusBar(wxobj), &StatusBar.New);
    }
    public void statusBar(StatusBar value)
    {
        wxFrame_SetStatusBar(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        wxFrame_SetStatusBarPane(wxobj, value);
    }
    ...
    {
        wxFrame_SetIcon(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return cast(MenuBar)FindObject(wxFrame_GetMenuBar(wxobj), &MenuBar.New);
    }
    ...
    {
        return cast(ToolBar)FindObject(wxFrame_GetToolBar(wxobj));
    }
    public void toolBar(ToolBar value)
    {
        wxFrame_SetToolBar(wxobj, wxObject.SafePtr(value));
    }
