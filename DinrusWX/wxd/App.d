...
public abstract class App : EvtHandler
{
    ...
    public void Run(char[][] args)
    {
        ...
        foreach (int i, char[] arg; args)
        {
            ...
            c_args[i] = cast(char*) вТкст0(вЮ8(str));
        }
    ...
    {
        return cast(string) new wxString(wxApp_GetVendorName(wxobj), true);
    }
    public void VendorName(string name)
    {
        wxApp_SetVendorName(wxobj, name);
    }
    public string AppName()
    {
        return cast(string) new wxString(wxApp_GetAppName(wxobj), true);
    }
    public void AppName(string name)
    {
        wxApp_SetAppName(wxobj, name);
    }
    ...
    {
        return cast(Window) FindObject(wxApp_GetTopWindow(wxobj));
    }
    public void TopWindow(Window window)
    {
        wxApp_SetTopWindow(wxobj, window.wxobj);
    }
