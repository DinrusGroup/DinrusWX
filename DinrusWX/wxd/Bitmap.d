...
public class Bitmap : GDIObject
{
    ...
    */
    ...
    {
        wxBitmap_SetHeight(wxobj, value);
    }
    ...
    public Mask mask()
    {
        return new Mask(wxBitmap_GetMask(wxobj));
    }
    public void mask(Mask value)
    {
        wxBitmap_SetMask(wxobj, wxObject.SafePtr(value));
    }
    ...
    {
        return new Palette(wxBitmap_GetPalette(wxobj));
    }
    ...
    {
        return new Palette(wxBitmap_GetColourMap(wxobj));
    }
