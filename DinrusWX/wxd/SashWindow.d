...
//
// $Id: SashWindow.d,v 1.9 2006/11/17 15:21:00 afb Exp $
//-----------------------------------------------------------------------------
...
public class SashWindow : Window
{
    ...
    {
        wxSashWindow_SetDefaultBorderSize(wxobj, value);
    }
    ...
    {
        wxSashWindow_SetExtraBorderSize(wxobj, value);
    }
    ...
    {
        wxSashWindow_SetMinimumSizeX(wxobj, value);
    }
    ...
    {
        wxSashWindow_SetMinimumSizeY(wxobj, value);
    }
    ...
    {
        wxSashWindow_SetMaximumSizeX(wxobj, value);
    }
    ...
    {
        wxSashWindow_SetMaximumSizeY(wxobj, value);
    }
}
...
public class SashEvent : CommandEvent
{
    ...
    {
        wxSashEvent_SetEdge(wxobj, value);
    }
    ...
    {
        wxSashEvent_SetDragRect(wxobj, value);
    }
    ...
    {
        wxSashEvent_SetDragStatus(wxobj, value);
    }

    private static Event New(IntPtr obj)
    {
        return new SashEvent(obj);
    }
