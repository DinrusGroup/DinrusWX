...
public class UpdateUIEvent : CommandEvent
{
    ...
    {
        return wxUpdateUIEvent_GetSetChecked(wxobj);
    }
    ...
    {
        return wxUpdateUIEvent_GetSetEnabled(wxobj);
    }
    ...
    public bool SetText()
    {
        return wxUpdateUIEvent_GetSetText(wxobj);
    }
    ...
    public string Text()
    {
        return cast(string) new wxString(wxUpdateUIEvent_GetText(wxobj), true);
    }
    public void Text(string value)
    {
        wxUpdateUIEvent_SetText(wxobj, value);
    }
    ...
    {
        wxUpdateUIEvent_SetMode(cast(int)value);
    }
    ...
    {
        return cast(int)wxUpdateUIEvent_GetUpdateInterval();
    }
    static void UpdateInterval(int value)
    {
        wxUpdateUIEvent_SetUpdateInterval(cast(uint)value);
    }
