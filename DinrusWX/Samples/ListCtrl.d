...
private import stdrus;
	...
	public class MyFrame : Frame
	{
		...
		public this(string title, Point pos, Size size)
		{
			...
			Bitmap bmp = new Bitmap( "./data/bitmaps/toolbrai.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/toolchar.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/tooldata.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/toolnote.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/tooltodo.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/toolchec.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/toolgame.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/tooltime.xpm" );
			m_imageListNormal.Add( bmp );
			bmp = new Bitmap( "./data/bitmaps/toolword.xpm" );
			m_imageListNormal.Add( bmp );
			
			bmp = new Bitmap( "./data/bitmaps/small1.xpm" );
