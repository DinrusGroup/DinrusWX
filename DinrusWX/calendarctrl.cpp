...
//
// $Id: calendarctrl.cpp,v 1.10 2007/01/15 11:55:34 afb Exp $
//-----------------------------------------------------------------------------
...
extern "C" WXEXPORT
wxc_bool wxCalendarCtrl_Create(_CalendarCtrl* self, wxWindow* parent, wxWindowID id, const wxDateTime* date, const wxPoint* pos, const wxSize* size, int style, wxc_string name)
{
	if (date == NULL)
...
extern "C" WXEXPORT
wxc_bool wxCalendarCtrl_SetDate(_CalendarCtrl* self, wxDateTime* date)
{
...
extern "C" WXEXPORT
wxDateTime* wxCalendarCtrl_GetDate(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarCtrl_SetLowerDateLimit(_CalendarCtrl* self, wxDateTime* date)
{
...
extern "C" WXEXPORT
wxDateTime* wxCalendarCtrl_GetLowerDateLimit(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarCtrl_SetUpperDateLimit(_CalendarCtrl* self, wxDateTime* date)
{
...
extern "C" WXEXPORT
wxDateTime* wxCalendarCtrl_GetUpperDateLimit(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarCtrl_SetDateRange(_CalendarCtrl* self, wxDateTime* lowerdate, wxDateTime* upperdate)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_EnableYearChange(_CalendarCtrl* self, wxc_bool enable)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_EnableMonthChange(_CalendarCtrl* self, wxc_bool enable)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_EnableHolidayDisplay(_CalendarCtrl* self, wxc_bool display)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_SetHeaderColours(_CalendarCtrl* self, wxColour* colFg, wxColour* colBg)
{
...
extern "C" WXEXPORT
wxColour* wxCalendarCtrl_GetHeaderColourFg(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxColour* wxCalendarCtrl_GetHeaderColourBg(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_SetHighlightColours(_CalendarCtrl* self, wxColour* colFg, wxColour* colBg)
{
...
extern "C" WXEXPORT
wxColour* wxCalendarCtrl_GetHighlightColourFg(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxColour* wxCalendarCtrl_GetHighlightColourBg(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_SetHolidayColours(_CalendarCtrl* self, wxColour* colFg, wxColour* colBg)
{
...
extern "C" WXEXPORT
wxColour* wxCalendarCtrl_GetHolidayColourFg(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxColour* wxCalendarCtrl_GetHolidayColourBg(_CalendarCtrl* self)
{
...
extern "C" WXEXPORT
wxCalendarDateAttr* wxCalendarCtrl_GetAttr(_CalendarCtrl* self, int day)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_SetAttr(_CalendarCtrl* self, int day, wxCalendarDateAttr* attr)
{
...
extern "C" WXEXPORT
void wxCalendarCtrl_SetHoliday(_CalendarCtrl* self, int day)
{
    self->SetHoliday(day);
}
...
extern "C" WXEXPORT
void wxCalendarCtrl_ResetAttr(_CalendarCtrl* self, int day)
{
    self->ResetAttr(day);
}
...
extern "C" WXEXPORT
wxCalendarHitTestResult wxCalendarCtrl_HitTest(_CalendarCtrl* self, wxPoint* pos, wxDateTime* date, wxDateTime::WeekDay *wd)
{
...
extern "C" WXEXPORT
void wxCalendarDateAttr_SetHoliday(wxCalendarDateAttr* self, wxc_bool holiday)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarDateAttr_HasTextColour(wxCalendarDateAttr* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarDateAttr_HasBackgroundColour(wxCalendarDateAttr* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarDateAttr_HasBorderColour(wxCalendarDateAttr* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarDateAttr_HasFont(wxCalendarDateAttr* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarDateAttr_HasBorder(wxCalendarDateAttr* self)
{
...
extern "C" WXEXPORT
wxc_bool wxCalendarDateAttr_IsHoliday(wxCalendarDateAttr* self)
{
...
extern "C" WXEXPORT
wxCalendarEvent* wxCalendarEvent_ctor2(_CalendarCtrl* cal, wxDateTime& dt, wxEventType type)
{
    return new wxCalendarEvent(cal, dt, type);
}
